            ...
            <form action="{{ route('place-order') }}" class="placeOrder" method="post">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-5">
                        ...
                        <div class="d-flex"><a class="" href="{{ route('store.details', [$store->slug]) }}"> + Add more items </a>{{$store->vendor_type == 'composition' ? '(Composition Vendor)' : ''}} </div>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        @if($store->vendor_type != 'composition')
                                        <th scope="col">Tax</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($cart as $ct)
                                        ...
                                        @php
                                            ...
                                            $tax =  _taxCalcluation($selling_price, $ct->tax)['gst_amount'] ;
                                            $taxable = _taxCalcluation($selling_price, $ct->tax)['price_excluding_gst'];
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: end;">-
                                        {{ \App\CentralLogics\Helpers::currency_symbol() }}{{ $item_total - $cart_total }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: end;">
                                        {{ \App\CentralLogics\Helpers::currency_symbol() }}{{ number_format($taxable_amount,2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">Tax Amount</th>
                                    <td style="text-align: end;">
                                        {{ \App\CentralLogics\Helpers::currency_symbol() }}{{ number_format($tax_amount ,2) }}
                                    </td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: end;">{{ \App\CentralLogics\Helpers::currency_symbol() }}
                                        ...
                                        <span
                                            id="total_amount">{{ _roundOff($cart_total  + $deliver_charges)['remaining_amount'] }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="text-align: end;">{{ \App\CentralLogics\Helpers::currency_symbol() }}
                                        <span
                                            id="total_amount">{{  number_format(_roundOff($cart_total  + $deliver_charges)['final_amount']) }}</span>
                                    </td>
                                </tr>
                                <input type="hidden" name="order_amount" id="order_amount"
                                    value="{{ _roundOff($cart_total  + $deliver_charges)['final_amount'] }}">
                            </tbody>
                        </table>
                        ...
                        <div class="row g-4 text-center align-items-center justify-content-center pt-4 ">
                            ...
                            @else
                                <div class="alert alert-danger order_alert" role="alert">
                                    Please add address <a type="button" class="btn btn-danger " data-bs-toggle="modal"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6">
                                <div class="form-item w-100">
                                    ...
                                    <input name="contact_person_number" oninput="this.value = this.value.slice(0, 10)"
