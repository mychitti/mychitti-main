    ...
    <div class="container">
        ...
        <form class="js-validate" action="{{ route('restaurant.store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="missingZoneModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Request Missing Zone</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="">
                                                <input type="text" id="placeSearchInp" placeholder="search place">
                                            </form>
                                        </div>
                            ...
                            <div class="form-group mb-4 position-relative">
                                <a href="javascript:;" data-bs-toggle="modal" style="right:0;" class=" position-absolute" data-bs-target="#missingZoneModal">Request Missing Zone</a>
                            ...
                            <div class="form-group mb-4">
                                <label class="input-label" for="choice_zones">Module</label>
                                <select name="module_id" id="module_select" required
                                    class="form-control __form-control js-select2-custom js-example-basic-single"
                                    data-placeholder="Module">
                                    <option value="5" selected>Shop</option>
            ...
            <div class="text-end pt-3">
                <button type="submit" class="btn btn-primary text-white btn-lg">{{ translate('messages.submit')
                }}</button>
            </div>
    </div>
    </form>
...
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCzWjsogpt6Ax0qDhvVq6NXVjRsYkictKQ&libraries=drawing,places">
</script>
...
<script type="text/javascript">
    ...
    let onloadCallback = function() {
        grecaptcha.render('recaptcha_element', {
            'sitekey': '{{ \App\CentralLogics\Helpers::get_business_settings('
            recaptcha ')['
            site_key '] }}'
        });
    };
