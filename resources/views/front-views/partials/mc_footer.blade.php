    ...
    <div class="container-fluid bg-dark text-white-50 footer pt-5 ">
        <div class="container p-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="d-flex gap-4 justify-content-end pt-3">
                            ...
                            <a class="text-white text-decoration-none me-2"
                                href="{{ route('mc-vendor-hub-tnc') }}">Terms and Conditions</a>
                                 <a class="text-white text-decoration-none me-2"
                                href="{{ route('mc-vendor-hub-pp') }}">Privacy Policy</a>
                            <a class="text-white text-decoration-none me-2" href="{{ route('mc-vendor.contact') }}">Contact</a>
                        </div>
                    </div>
            ...
            <div class="col-12 text-center">
                © 2025 My Chitti. All rights reserved.</div>
        </div>
    </div>