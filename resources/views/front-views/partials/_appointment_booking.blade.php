    ...
    <div class="appt-inner">
        ...
        <div class="appt-header">
            <div class="appt-header-left">
                ...
                <div>
                    <h3 class="appt-title">Book an Appointment</h3>
        ...
        <div class="appt-doctors-row">
            ...
            <a class="appt-doctor-card"
                href="{{ route('front.appointment.book', [request()->segment(1), $store->slug]) }}?doctor_id={{ $d->id }}">
...
<style>
    ...
    .appt-icon { font-size: 28px; line-height: 1; }
    .appt-title {
        font-size: 18px;
        font-weight: 700;
        color: #1e3a5f;
    ...
    .appt-btn-full:hover { background: #1d4ed8; }
    ...
    .appt-doc-info { flex: 1; min-width: 0; }
    .appt-doc-name {
        font-size: 13px;
        font-weight: 700;
        color: #111;
    ...
    .appt-doc-fee.free { color: #7c3aed; }
    .appt-book-badge {
        font-size: 11px;
        color: #2563eb;
        font-weight: 600;
    ...
    @media (max-width: 600px) {
        .appt-inner { padding: 18px 16px; }
        .appt-doctor-card { max-width: 100%; flex: 1 1 100%; }
        .appt-btn-full { width: 100%; text-align: center; }
