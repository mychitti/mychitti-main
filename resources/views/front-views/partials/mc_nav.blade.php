 @php
 $logo = asset('storage/app/public/vendor_login/mc_vendor_logo.jpeg'); @endphp
     ...
     <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" style="width:fit-content; justify-content: end;" id="navbarNavAltMarkup">
             <div class="navbar-nav">
                 <a href="{{ route('vendor_homepage') }}" class="my-nav-link nav-link ">Home</a>
 ...
 {{-- <nav style=" width: 100%;position: fixed; top: 0px; z-index: 2;"
     ...
     <ul class="my-nav mb-0 justify-content-center d-flex list-unstyled collapse navbar-collapse">
         <li class="mx-4">
             <a href="{{ route('vendor_homepage') }}" class="my-nav-link nav-link ">Home</a>
         </li>
         <li class="mx-4">
         ...
         <li class="mx-4">
             <a href="{{ route('vendor_homepage') }}#pricing_section" class="my-nav-link nav-link">Pricing</a>
         </li>
