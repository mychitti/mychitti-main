...
@section('content')
    <div class="store-template template-2">
        ...
        <div class="store-hero">
            <nav style=" width: 100%;position: fixed; top: 0px; z-index: 2;"
                ...
                <div class="">
                    <img loading="lazy" class="store_logo"
            ...
            <section class="trust-hero" id="home">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h1 class="trust-title">
                            ...
                            <div class="trust-rating">
                                ...
                                <span>⭐ ({{ $store->rating_count }} Reviews)</span>
                            </div>
            ...
            <section class="trust-info-bar">
                <div class="container">
                    <div class="row text-center">
                        <div class="col">
                            <strong>📍 Address</strong>
                            <p>{{ Str::limit($store['address'], 40) }}</p>
                        </div>
                        <div class="col">
                            <strong>📞 Phone</strong>
                            <p>{{ $store['phone'] }}</p>
                        ...
                        <div class="col">
                            ...
                            <p>{{ $store->active ? 'Open Now' : 'Closed' }}</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container-fluid fruite">
                <div class="container">
                    ...
                    <div class="" id="">
                        ...
                        @endif
                        <section class="trust-services" id="services">
                            <div class="container">
                                                                ...
                                                                @foreach ($cat->items as $pro)
                                                                    @php
                                                                        ...
                                                                        $firstVr = !empty($variations)
                                                                            ...
                                                                            : '';
                                                                        if ($firstVr) {
                                                                            $selling_price = json_decode($firstVr)
                                                                                ->price;
                                                                            $mrp =
                                ...
                                <div class="owl-carousel gallery-carousel justify-content-center  ">
                                    @foreach ($data['galleries'] as $key => $value)
                                        <a target="_blank"
                                            ...
                                            alt="Gallery image"><img loading="lazy" style="min-height:100px;"
                                                loading="lazy"
                                        ...
                                        <div class="col-lg-7" id="nav-mission">
                                            ...
                                            @elseif($data['review_count'] > 2)
                                                <div class="border p-2 ">
                                                    <a href="{{ route('store.reviews', [$store->slug]) }}">View All
                                                        Reviews <i class="fa fa-solid fa-arrow-right"></i></a>
                                                </div>
                                            @endif
                                ...
                                <div class="contact-container">
                                    ...
                                    <div class="contact-box ">
                                        <div class="icon-circle">
                                            <img loading="lazy" src="https://img.icons8.com/ios-filled/50/map.png"
                                                alt="Address Icon" />
                                        </div>
                                    ...
                                    <div class="contact-box ">
                                        <div class="icon-circle">
                                            <img loading="lazy"
                                                src="https://img.icons8.com/ios-filled/50/secured-letter.png"
                                                alt="Email Icon" />
                                        </div>
                                    ...
                                    <div class="contact-box ">
                                        <div class="icon-circle">
                                            <img loading="lazy" src="https://img.icons8.com/ios-filled/50/phone.png"
                                                alt="Email Icon" />
                                        </div>
                                    ...
                                    <div class="contact-box ">
                                        <div class="icon-circle">
                                            <img loading="lazy" src="https://img.icons8.com/ios-filled/50/marker.png"
                                                alt="Email Icon" />
                                        </div>
