    ...
    <div class="gate-pass">
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                <div class="info-item">
                    ...
                    <span class="info-value">__________________</span>
                </div>
            </div>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%;" class="text-right">Reason</th>
                        <th style="width: 15%;" class="text-right">Amount</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($gatepass_items as $key => $value)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            ...
                            <td class="text-center">{{$value->returned == 1 ? $value->return_stock : ''}}</td>
                            <td class="text-right">{{$value->returned == 1 ? $value->return_reason : ''}}</td>
        ...
        <div class="summary">
            ...
            <div class="summary-row">
                ...
                <span class="value">{{ $gatepass_items->sum('qty') }}</span>
            </div>
            <div class="summary-row total">
                <span class="label">TOTAL AMOUNT:</span>
                <span class="value">{{ _price($gatepass->total_amount) }}</span>
            </div>
        </div>
