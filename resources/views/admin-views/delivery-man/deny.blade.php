                    ...
                    <form class="search-form">
                        <div class="input-group input--group">
                            <input type="search" name="search_by" class="form-control"
                                ...
                                aria-label="{{ translate('messages.search') }}" value="{{ request()?->search_by }}">
                                    ...
                                    @else
                                        <div class="col-md-12">
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary request-alert"
                                                ...
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    data-toggle="tooltip" data-placement="top"
                                                    data-original-title="{{ translate('messages.edit') }}"
                                                    href="{{ route('admin.users.delivery-man.edit', [$dm['id']]) }}"><i
                                                        class="tio-edit"></i>
                                                </a>
                                                @if ($dm->application_status != 'denied')
                                                    <a class="btn action-btn btn--danger btn-outline-danger request-alert"
                                                        data-toggle="tooltip" data-placement="top"
