                ...
                <div class="col-md-12">
                    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
                        ...
                        <ul class="nav nav-tabs mb-3 border-0 nav--tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('admin.store.pending-requests') }}"   aria-disabled="true">Pending {{Config::get('module.current_module_id') == 8 ? 'Hospitals' :translate('messages.stores')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.store.deny-requests') }}"  aria-disabled="true">{{translate('messages.denied')}} {{Config::get('module.current_module_id') == 8 ? 'Hospitals' :translate('messages.stores')}}</a>
                            </li>
                        </ul>
                        <!-- End Nav -->
                    </div>
                    ...
                    <!-- Search -->
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="Search {{Config::get('module.current_module_id') == 8 ? 'Hospital' :translate('messages.name or Phone')}}" value="{{isset($search_by) ? $search_by : ''}}" aria-label="{{translate('messages.search')}}" required>
            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tr>
                        ...
                        <th class="border-0">{{Config::get('module.current_module_id') == 8 ? 'Hospital' :translate('messages.store')}} {{translate('messages.information')}}</th>
                        <th>Created By</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn--container">
                                    ...
                                    <button class="btn action-btn btn--danger btn-outline-danger float-right" type="button" data-toggle="modal" data-target="#reasonModal{{$store->id}}">
                                    <i class="tio-clear font-weight-bold"></i>
                                    </button>
                                    <div class="modal fade" id="reasonModal{{$store->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('admin.store.deny-application')}}" method="post">
                                                    @csrf
                                                    <input type="hidden" name="store_id" value="{{$store['id']}}">
                                                    <textarea class="form-control" name="reason" placeholder="Reason..." id=""></textarea>
                                                <button class="btn btn-sm btn--danger btn-outline-danger float-right my-2" type="submit"
                                                       >Deny</button>
                                                </form>
