...
@section('title', translate('messages.add_hospital'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('messages.add_new_hospital') }}
                </span>
            </h1>
        </div>
                            ...
                            <div id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" class="form-control"
                                        placeholder="{{ translate('messages.hospital_name') }}" required>
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <textarea type="text" name="address[]" placeholder="{{ translate('messages.hospital') }}"
                    ...
                    <div class="card shadow--card-2">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span>{{ translate('Hospital Logo & Covers') }}</span>
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="my-3">
                                            ...
                                            <label for="confirmation_check">Hospital's annual turnover is below 20
                                                lakhs.</label>
                                        </div>
