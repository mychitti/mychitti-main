...
@section('title', Config::get('module.vendor_role') . translate(' Bulk Import'))
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{Config::get('module.vendor_role')}} {{translate('messages.bulk_import')}}
                </span>
            </h1>
        </div>
        <!-- Content Row -->
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="export-steps-item-2 h-100">
                                ...
                                <ul class="m-0 pl-4">
                                    ...
                                    <li>
                                       {{ translate('After_uploading ') . Config::get('module.vendor_role') . translate(' you_need_to_edit_them_and_set_stores`s_logo_and_cover.`s_path')}}
                                    </li>
                                    <li>
                                       {{ translate('You_can_upload_your ') . Config::get('module.vendor_role')  . translate(' images_in ') . Config::get('module.vendor_role') . translate(' folder_from_gallery,_and_copy_image`s_path') }}
                                    </li>
                                    <li>
        ...
        <div class="card mt-2 rest-part">
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <h5 class="text-capitalize mb-3">Import {{Config::get('module.vendor_role')}} files</h5>
                        <div class="uploadDnD">
