    ...
    <div id="printableArea">
        <div>
            ...
            <div class="print--invoice initial-38-1">
                ...
                @if($order['invoice_id'] )
                    <h5 class="d-flex justify-content-center"><span>{{ translate('invoice_id') }}</span> <span>:</span> <span>{{ $order['invoice_id'] }}</span></h5>
                    @else
                                    ...
                                    <tr>
                                        ...
                                        @else
                                            @if (count(json_decode($detail['variation'], true)) > 0)
                                                ...
                                                @foreach (json_decode($detail['variation'], true)[0] as $key1 => $variation)
                                                    @if ($key1 != 'stock' && $key1 != 'images')
                                                        <div class="font-size-sm text-body">
                                                            <span>{{ $key1 }} : </span>
                                                            <span
                                                                class="font-weight-bold">{{ $key1 == 'price' ? \App\CentralLogics\Helpers::format_currency($variation) : ($key1 == 'type' ? $variation : $key1) }} </span>
                                                        </div>
                                                    @endif
                                                @endforeach
                                            @endif
                ...
                <div class="checkout--info">
                    <dl class="row text-right">
                        ...
                        <dd class="col-6 total">
                            ...
                            {{-- {{ \App\CentralLogics\Helpers::format_currency($order->order_amount - ($order['store_discount_amount'] + $order['flash_admin_discount_amount'] + $order['flash_store_discount_amount'])) }}</dd> --}}
