...
@section('content')
    <div class="content container-fluid">
        @php($parcel_order = Request::is('parcel/orders*'))
        <!-- Page Header -->
                    ...
                    <form class="search-form min--260">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" name="search" class="form-control h--40px"
                                ...
                                value="{{ request()?->search ?? null }}" aria-label="{{ translate('messages.search') }}">
                            @if ($parcel_order)
                                        ...
                                        @if (!$parcel_order)
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <label class="toggle-switch toggle-switch-sm"
                                                    for="toggleColumn_item_quantity">
                                                    <input type="checkbox" class="toggle-switch-input"
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="table-column-pl-0 border-0">{{ translate('messages.invoice_id') }}</th>
                    ...
                    <tbody id="set-rows">
                        @foreach ($orders as $key => $order)
                            <tr class="status-{{ $order['order_status'] }} class-all">
                                ...
                                <td class="table-column-pl-0">
                                    <a
                                        href="{{ route($parcel_order ? 'admin.parcel.order.details' : 'admin.order.details', ['id' => $order['id']]) }}">{{ $order['invoice_id'] }}</a>
                                </td>
                                <td>
                                    <div>
                                        <div>
                                ...
                                <td>
                                    @if ($order->is_guest)
                                        ...
                                        <a href="javascript:;" style="cursor:default;"
                                            class="textToCopy">{{ $customer_details['contact_person_number'] }}</a>
                                    ...
                                    @elseif($order->customer)
                                        ...
                                        <a href="javascript:;" style="cursor:default;"
                                            class="textToCopy">{{ $order->customer['phone'] }}</a>
                                        <button class="copy-btn bg-transparent outline-none border-0">
                                            <i class="tio-copy"></i>
                                        </button>
                                    @else
    ...
    @push('script_2')
        ...
        <script>
            ...
            $('#reset').on('click', function() {
                // e.preventDefault();
                location.href = '{{ url('/') }}/order/filter/reset';
            });
