...
@section('content') 
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-filter-list"></i> Keywords<span class="badge badge-soft-dark ml-2" id="itemCount">{{count($keywords)}}</span></h1>
...
<div class="row">
        ...
        <div class="card col-6">
            ...
            <div class="card-header py-2">
                <div class="search--button-wrapper">
                    <h5 class="card-title">Keyword List</h5>
