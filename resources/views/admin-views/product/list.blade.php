                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Item to show on homepage</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form method="post" action="{{route('admin.item.update-homepage-item')}}">
                                <div class="modal-body">
                                    @if (Config::get('module.current_module_id') == 5)
                                        <label class="form-check-label" for="flexRadioDefault2">Product</label>
                                    @else
                                        <label class="form-check-label" for="flexRadioDefault2">Service</label>
                                    @endif
                                    <select name="item_id" class="form-control js-select2-custom">
                                        <option value=""></option>
            ...
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper justify-content-between">
                    <form method="post" action="{{ route('admin.item.bulk_delete') }}"
                        ...
                        <button type="submit" class="btn btn-outline-primary m-1 bulk_form_btn">Apply</button>
                    </form>
            ...
            <div class="table-responsive datatable-custom" id="table-div">
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            <th class="border-0"><input name="" id="select_all_items" type="checkbox" /></th>
                    ...
                    <tbody id="set-rows">
                        @foreach ($items as $key => $item)
                            <tr>
                                <td><input name="item_id[]" value="{{ $item['id'] }}" class="check_item"
                                        type="checkbox" /></td>
        ...
        $(".bulk_form").on('submit', function(e) {
            ...
            swal({
                ...
                if (isConfirm.value) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.item.bulk_delete') }}", // Replace with your actual route
                        type: 'POST',
                        data: {
                            item_id: selectedIds
                        },
