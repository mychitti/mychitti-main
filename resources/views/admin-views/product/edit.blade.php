                    ...
                    <div class="card h-100">
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-0 col-md-6">
                                ...
                                <input type="text" name="short_desc" value="{{$product->short_desc}}" placeholder="Professional {SERVICE_NAME} Experts" class="form-control" id="short_desc">
                            </div>
                ...
                @if (Config::get('module.current_module_id') == 5)
                    <div class="col-md-12">
                        <div class="card shadow--card-2 border-0">
                            ...
                            <div class="card-body">
                                <textarea id="editor">{{ $product->specifications }}</textarea>
                            </div>
                        </div>
                    </div>
                @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="areas_input">Areas
                                            <textarea class="form-control auto-expand" name="areas" id="areas_input">{{ $item_area_keywords?->keyword }}</textarea>
                                    </div>
                                </div>
                                @if (Config::get('module.current_module_id') == 5)
                                    <div class="col-sm-6 col-lg-3">
                                ...
                                @if (Config::get('module.current_module_id') != 6)
                                    ...
                                    <div class="col-sm-6 col-lg-3">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="number" min="0" value="{{ $product->hsn_code }}"
                                                max="999999999999" name="hsn_code" id="" class="form-control"
                                ...
                                <div class="row g-2">
                                    <div class="col-sm-4 col-6">
                                        <div class="form-group mb-0">
                                            ...
                                            <input oninput="calcValues()" type="number"
                                                value="{{ $product->mrp_price }}" min="0" max="999999999999.99"
                                                name="mrp_price" class="form-control" step="0.001"
                                                placeholder="{{ translate('messages.Ex:') }} 100" required>
                                        </div>
                                    </div>
                                    {{-- <input type="hidden" name="mychitty_fee" id="mychitty_fee"> --}}
                                    <div class="col-sm-4 col-6">
                                        <div class="form-group mb-0">
                                            <label class="input-label"
                                            ...
                                            <div class="input-group mb-3">
                                                <input oninput="calcValues()" type="number"
                                                    value="{{ $product->asking_price - $product->remaining_amount }}"
                                                    min="0" max="999999999999.99" name="asking_price"
                                            ...
                                            <select name="fee_category" id="fee_category" onchange="calcValues()"
                                                ...
                                                @foreach ($fee_categories as $key => $fee)
                                                    <option data-value="{{ $fee->total_fee }}"
                                                        value="{{ $fee->id }}"
                                                        {{ $product->fee_category == $fee->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-4 col-6">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="number" id="selling_price_inp" value="{{ $product['price'] }}"
                                    ...
                                    <div class="col-sm-4 col-6">
                                        <div class="form-group mb-0">
                                            <label class="input-label"
                                                ...
                                                <span id=symble>
                                                    {{ $product['discount_type'] == 'amount' ? \App\CentralLogics\Helpers::currency_symbol() : '(%)' }}</span>
                                            </label>
                                            <input type="number" min="0" value="{{ $product['discount'] }}"
                                                max="100000" name="discount" class="form-control non_changeable"
                                                placeholder="{{ translate('messages.Ex:') }} 100" step="0.000001"
                                    ...
                                    <div class="col-sm-4 col-6">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="number" min="0" value="{{ $product['mychitty_fee'] }}"
                                                max="100000" class="form-control non_changeable" name="mychitty_fee"
                                                placeholder="{{ translate('messages.Ex:') }} 100" id="mychitty_fee"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="number" min="0" max="999999999999" name="gst_percent"
                                                id="" class="form-control" value="{{ $product->tax }}"
                ...
                <div class="col-12">
                    ...
                    <div class="seo-section">
                        ...
                        <div class="collapse show" id="seoCollapse">
                            <div class="pt-3 px-3">
                                <h4>Placeholders: </h4>
                                <p><code>{CITY_NAME}</code>, <code>{SERVICE_NAME}</code>, <code>{LOCALITIES}</code>, <code>{SAME_CATEGORY_SERVICES}</p>
                            </div>
                            <div class="seo-body">
                                        ...
                                        <div class="border rounded p-3 mb-3 row">
                                            ...
                                            <div class="form-group mb-0 col-md-8">
                                                ...
                                                <textarea type="text" class="form-control" rows="1"
                                                    ...
                                                    name="meta_desc" id="">{{ $product->meta_desc }}</textarea>
                                            </div>
                                            <div class="form-group mb-0 col-md-4">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $product->seo_heading }}" name="seo_heading"
                                            ...
                                            <div class="form-group mb-0 col-md-4">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <a type="button" class="text-underline" data-toggle="modal"
                                ...
                                <div class="card border-0 shadow-sm mb-3">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-file-alt mr-2 text-primary"></i> SEO Footer
                                            Content</h5>
                                    </div>
                                    <div class="card-body">
                                        <div id="seoContentContainer">
                                            @if (count($seoContents))
                                                @foreach ($seoContents as $key => $value)
                                                    <div class="seo-content-item border rounded p-3 mb-3"
                                                        data-index="{{ $key + 1 }}">
                                                        <div class="form-group mb-0">
                                                            <label class="form-label">SEO Content (Option
                                                                {{ $key + 1 }})</label>
                                                            <textarea class="form-control ck_editor" id="seo_editor_{{ $key + 1 }}"
                                                                placeholder="Enter SEO-friendly content for your service">{{ $value->content }}</textarea>
                                                        </div>
                                                        <button type="button"
                                ...
                                <div class="card border-0 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div id="faqContainer">
                                            @if (count($faqContents))
                                                @foreach ($faqContents as $key => $value)
                                                    <div class="faq-item border rounded p-3 mb-3"
                                                        data-index="{{ $key + 1 }}">
                                                        <div class="form-group mb-0">
                                                            <label class="form-label">FAQ (Option
                                                                {{ $key + 1 }})</label>
                                                            <textarea class="form-control ck_editor" id="faq_editor_{{ $key + 1 }}" placeholder="Enter FAQ content">{{ $value->content }}</textarea>
                                                        </div>
                                                        <button type="button"
...
@push('script_2')
    ...
    <script>
        ...
        function combination_update() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.item.update-variant-combination') }}",
