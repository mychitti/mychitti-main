...
@section('title',translate('New_Product_requests'))
            ...
            <div class="row align-items-center g-2">
                <div class="col-md-9 col-12">
                    <h1 class="page-header-title">
                        ...
                        <span>
                            {{translate('messages.New_Product_requests')}} <span class="badge badge-soft-dark ml-2" id="foodCount">{{$items->total()}}</span>
                        </span>
                    </h1>
                </div>
            </div>
                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    {{-- @csrf --}}
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch" name="search" value="{{ request()?->search ?? null }}" type="search" class="form-control h--40px" placeholder="{{translate('ex_:_search_product_name')}}" aria-label="{{translate('messages.search_here')}}">
