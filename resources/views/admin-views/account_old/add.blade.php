...
@section('content')
    <div class="content container-fluid">
        <div class="content container-fluid">
            ...
            @endif
            <div class="row g-2">
                <form enctype="multipart/form-data" class="w-100" action="{{ route('vendor.account.save') }}"
                    method="post">
                    @csrf
                    ...
                    <div class="col-md-12">
                        <div class="card h-100">
                            <div class="card-body row">
                                ...
                                <div class="form-row col-4">
                                    <label for="exampleInputEmail1">Name of Company / Person</i> <span
                                ...
                                <div class="form-row col-4">
                                    ...
                                    <input type="number" name="bill_numer" placeholder="Bill Number / Details"
                                        class="form-control">
                                </div>
                                <div class="form-row col-4">
                                ...
                                <div class="form-row col-4">
                                    ...
                                    <input type="file" name="file" id="" accept=".doc, .docx, .pdf"
                                        class="form-control">
                                </div>
