                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input class="form-control" type="number" min=".01" step="0.001" name="amount" id="amount" max="999999999999.99" placeholder="{{translate('messages.Ex_:_1000')}}">
                        </div>
                    </div>
                    <div class="col-lg-12">
...
<script>
    ...
    $('#store').on('change', function() {
        $.get({
            url: '{{url('/')}}/store/get-account-data/'+this.value,
            dataType: 'json',
    ...
    $('#deliveryman').on('change', function() {
        $.get({
            url: '{{url('/')}}/users/delivery-man/get-account-data/'+this.value,
            dataType: 'json',
            success: function (data) {
                $('#account_info').html('({{translate('messages.cash_in_hand')}}: '+data.cash_in_hand+' {{translate('messages.total_earning')}}: '+data.earning_balance+')');
            },
