            ...
            <h1 class="page-header-title"><i class="tio-filter-list"></i> Reports  <span class="badge badge-soft-dark ml-2"
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="{{ route('admin.users.attendance.export', ['type' => 'excel', request()->getQueryString()]) }}">
                ...
                <tbody id="set-rows">
                    @foreach ($staff as $key=> $lead)
                        <tr>
                            ...
                            <td title="Total Leaves taken during {{$fromdate}} to {{$todate}}">{{ $lead['casual_leaves'] }}</td>
