            ...
            <div class="col-md-12">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-8 shadow shadow-sm m-2 calendar p-3" style="background-image: linear-gradient(45deg, #ffffff, #6f9ef557);
                                ...
                                <ul class="day-list">
                                    ...
                                    <select class="att_status" style="height: 25px;width: 100%;border: 0px;background: #ffffff80;" data-id="{{$t}}">
                                        ...
                                        <option value="SL" {{ in_array($t, $daArr) && $labelArr[array_search($t, $daArr)] == 'SL' ? 'selected': '';}}>SL</option>
                        ...
                        <div class="form-row">
                            <form action="{{route('admin.users.attendance.save')}}" id="att_form" method="post">
                                @csrf
