                        ...
                        <div class="col-md-5">
                            <div class="zone-setup-instructions">
                                <div class="zone-setup-top">
                                    ...
                                    <p>
                                        {{ translate('Create_&_connect_dots_in_a_specific_area_on_the_map_to_add_a_new_business_city.') }}
                                    </p>
                                </div>
                                <div class="zone-setup-item">
                                    ...
                                    <div class="info">
                                        {{ translate('Use_this_‘Hand_Tool’_to_find_your_target_city.') }}
                                    </div>
                                </div>
                                <div class="zone-setup-item">
                                    <div class="zone-setup-icon">
                            ...
                            <div class="pl-xl-5 pl-xxl-0">
                                ...
                                <div class="tab-content">
                                    <div class="form-group lang_form" id="default-form">
                                        <label class="input-label" for="exampleFormControlInput1">Business City name </label>
                                        <input type="text" name="name[]" class="form-control" placeholder="Business City name" maxlength="191"  >
                                    </div>
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">
                                {{translate('messages.city_list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$zones->total()}}</span>
                            </h5>
