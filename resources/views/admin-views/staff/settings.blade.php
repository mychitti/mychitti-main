...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row g-2">
            <form class="w-100 p-0" action="{{ route('admin.staff.settings.save') }}" method="post">
                @csrf
                <div class="form-row col-md-4">
                    <div class="d-flex justify-content-between w-100">
                        <label for="">Employee Id Prefix</label>
                        <label class="toggle-switch toggle-switch-sm" for="toggleColumn_name">
                            <input {{$prefix_status ? 'checked' : ''}} name="prefix_status" value="1" type="checkbox" class="toggle-switch-input" id="toggleColumn_name">
                    ...
                    <input type="text" value="{{$prefix_status ? $emp_prefix : ''}}" {{$prefix_status ? '' : 'disabled'}}  maxlength="3"   class="form-control alphaInput" name="prefix" id="prefix_inp" placeholder ="EX : SFT">
