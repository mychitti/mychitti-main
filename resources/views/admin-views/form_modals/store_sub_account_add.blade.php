            ...
            <div class="modal-body p-0">
                <div class="form-panel">
                    ...
                    <form id="accountForm" enctype="multipart/form-data"
                        action="{{ route('admin.account.setting.chart-of-account.account-store') }}" method="post">
                        @csrf
                        <h4 class="parent_account_show"></h4>
                        <span class="badge badge-soft-primary">
                            <i class="tio-info-outined"></i> First create the cost centers in the <a href="{{route('admin.account.setting.chart-of-account.index')}}" class="text-underline">Ledger Accounts</a>
                        </span>

                        @if (Route::currentRouteName() != 'admin.account.setting.chart-of-account.detail')
