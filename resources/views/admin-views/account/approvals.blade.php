                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{route('admin.account.request_rule_edit', [$rule['id'] ])}}"
                                    ...
                                    <form action="{{ route('admin.account.request_rule_delete', [$rule->id]) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <form class="" action="{{ route('admin.account.request_rule_store') }}" method="post">
                        @csrf
...
@push('script_2')
    ...
    <script>
        ...
        function fetchEmployees() {
            ...
            $.post({
                url: '{{ route('admin.account.fetchEmployees') }}',
                data: {
                    dep: dep,
                    role: role,
                },
        ...
        {{-- $(".edit_rule_btn").on('click', function() {
            ...
            $.ajax({
                url: "{{ route('admin.account.request_rule_edit') }}",
                type: 'POST',
                data: {
                    id: id,
                },
