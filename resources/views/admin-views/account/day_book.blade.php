                    ...
                    <div class="d-flex gap-2">
                        ...
                        @if (hasPermission('boa_day_book', 'export'))
                            <a class="btn btn--primary  btn_sm "
                                href="{{ route('admin.account.day-book.export') }}?date={{ date('Y-m-d') }}"><i
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('admin.account.day-book.import-excel') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <a href="{{ asset('storage/app/public/util/example-daybook-import.xlsx') }}"
