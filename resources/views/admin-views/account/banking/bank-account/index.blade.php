    ...
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex flex-wrap justify-content-between align-items-center w-100">
            ...
            <div class="page-header-select-wrapper">
                ...
                @include('admin-views.form_modals.import_transactions')
                ...
                @include('admin-views.form_modals.add_store_bank_account')
                @endif
        ...
        <div class="row my-3  ">
                        ...
                        <div class="folder-content ">
                            ...
                            <div class="dropdown position-absolute" style="    right: 10px;top: 8px; z-index: 10;">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <form
                                        action="{{ route('admin.account.banking.bank-account.delete', [$account['id']]) }}"
                            ...
                            <a href="{{ hasPermission('banking_bank_accounts', 'view')  ? route('admin.account.banking.bank-account.detail', $account->id) : '#' }}"
            ...
            @if (count($accounts) >= 2)
                <div class="folder">
                    ...
                    <div class="folder-back-extension"></div>
                    <div class="folder-cutout"></div>
                    <a href="{{ hasPermission('banking_bank_accounts', 'view')  ? route('admin.account.banking.bank-account.detail-main') : '#' }}" class="folder-main">
                        <div class="folder-content ">
                            {{-- <input type="hidden" class="bank_id_inp" name="bank_id" value=""> --}}
                            <div class="folder-content_0 ">

                                <div class="bank-title">
                                    Main Bank {{ \App\Models\BusinessSetting::where('key', 'business_name')->first()?->value ?? '' }}</div>
...
@push('script_2')
    ...
    <script>
        ...
        var routeTemplate = "{{ route('admin.account.banking.bank-account.update', ['__ID__']) }}";
