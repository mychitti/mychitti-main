        ...
        <div class="page-header">
            ...
            <div class="page-header-select-wrapper d-flex gap-2 flex-wrap">
                ...
                {{-- @if (hasPermission('boa_journal_entry', 'export'))
                    <a class="btn btn-outline-primary  btn_sm " href="{{ route('admin.account.journal-entry.export') }}">
                        Export </a>
                @endif --}}
            </div>
        </div>
                                                ...
                                                @foreach ($entry->ledgerEntries as $line)
                                                    ...
                                                    <tr>
                                                        <td>
                                                            @if ($store_user)
                                                                <a
                                                                    href="{{ route('admin.client.view', [$store_user->id]) }}">{{ $line->account?->name }}</a>
                                                            @else
                                                                {{ $line->account?->name }}
                                                            @endif
                                                        </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.account.journal-entry.import') }}" method="post"
