...
@section('content')
    ...
    <div class="content container-fluid">
                        ...
                        <div class="folder">
                            ...
                            <div class="folder-main folder-main-level-{{ $account->level }}">
                                <div class="folder-content ">
                                    ...
                                    <a href="{{ route('admin.account.setting.chart-of-account.detail', $account->id) }}"
                                        ...
                                        <div class="upload-section">
                                            ...
                                            @if ($account->self_added)
                                                ...
                                                <form
                                                    action="{{ route('admin.account.setting.chart-of-account.account-delete', [$account['id']]) }}"
        ...
        @include('admin-views.form_modals.store_sub_account_add')
                    ...
                    <div class="modal-body p-0">
                        <div class="form-panel">
                            ...
                            <form id="accountForm" enctype="multipart/form-data"
                                action="{{ route('admin.account.setting.chart-of-account.account-store') }}"
                                method="post">
                                @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                        <div class="form-panel">
                            ...
                            <form id="accountForm" enctype="multipart/form-data"
                                action="{{ route('admin.account.setting.chart-of-account.account-update') }}"
                                method="post">
                                @csrf
