            ...
            <div class=" col-md-3 actions-panel">
                ...
                <div class="action-list">
                    @if (hasPermission('boa_master_ledger', 'add'))
                        <a href="{{ route('admin.account.add', ['add']) }}" class="action-item">
                    ...
                    @if (hasPermission('apporval_form_master_ledger', 'list'))
                        <a href="{{ route('admin.account.request-form.master-ledger.index', ['id' => 0, 'tab' => 'approvals']) }}"
                            class="action-item">
                    ...
                    <a href ="{{ route('admin.billing.manual-bill') }}" class="action-item">
