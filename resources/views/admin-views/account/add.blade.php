        ...
        <div class="page-header d-flex flex-wrap justify-content-between align-items-center w-100">
            ...
            <div class="page-header-select-wrapper d-flex gap-2 flex-wrap">
                ...
                @if (hasPermission('boa_master_ledger', 'export'))
                    <a href="{{ route('admin.account.master-ledger.export') }}" class="btn btn_sm btn-outline-primary ">
                        Export
                    </a>
                @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.account.master-ledger.import') }}" method="post"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    @include('admin-views.forms.master_ledger_entry')
...
@push('script_2')
    ...
    <script>
        ...
        $('#myTable tr').click(function() {
            ...
            $.post({
                url: "{{ route('admin.account.master-ledger.get-entry-details') }}",
