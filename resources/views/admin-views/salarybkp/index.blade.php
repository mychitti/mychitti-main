                            ...
                            <tr>
                                    ...
                                    <div>
                                        <a href="#" class="table-rest-info" alt="view store">
                                            ...
                                            <div class="info">
                                                ...
                                                @php 
                                        $depNm = _getWhere('admins', ['id'=> $lead->ven_id]);
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        href="{{ $lead->id ? route('admin.users.salary.edit',[$lead->id]) : '#'}}"title="{{translate('messages.edit')}} Salary"><i class="tio-edit"></i>
                                        </a>
                                        <a style="min-width:50px;" class="btn  btn--danger btn-outline-danger"
                                            href="{{ $lead->id ?  route('admin.users.salary.delete', [$lead->id]) : '#' }}"
