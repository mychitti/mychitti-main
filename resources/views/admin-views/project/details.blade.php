                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap">
                    <div class="flex-grow-1 mb-3 mb-md-0">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            ...
                            @if (hasPermission('project', 'status_change'))
                                <form action="{{ route('admin.project.progress-status-change', [$project->id]) }}">
                    ...
                    <div> 
                        @if (hasPermission('project_task', 'add'))
                            <a href="{{ route('admin.project.task.add', $project->id) }}" class="btn text-white"
                        ...
                        @if (hasPermission('project', 'edit'))
                            <a href="{{ route('admin.project.edit', $project->id) }}" class="btn text-white"
                                style="background-color: var(--primary);">
                        ...
                        <div class="tab-pane fade {{ request('tab') && request('tab') == 'milestones' ? 'show active' : '' }}"
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                @if (hasPermission('project_milestone', 'add'))
                                    ...
                                    @include('admin-views.form_modals.milestone_modal')
                                @endif
                            </div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-start">
                                                    ...
                                                    {{ $milestone->status }}
                                                        ...
                                                        @if (hasPermission('project_milestone', 'status_change'))
                                                            <form
                                                                action="{{ route('admin.project.milestone.status-change', [$milestone->id]) }}">
                                                        ...
                                                        @if (hasPermission('project_milestone', 'delete'))
                                                            ...
                                                            <form
                                                                action="{{ route('admin.project.milestone.delete', [$milestone['id']]) }}"
                    ...
                    <div class="tab-pane fade {{ request('tab') && request('tab') == 'team' ? 'show active' : '' }}"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ $project?->projectManager ? route('admin.employee.view', [$project?->projectManager?->id]) : 'javascript:;' }}"
                                                class="d-flex gap-2 align-items-center">
                                                <img style="height: 37px;width: 37px;border-radius: 50%;"
                                                    src="{{ asset('storage/app/public/admin') . '/' . $project?->projectManager?->image }}"
                                                    alt="">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if ($project->teamMembers && $project->teamMembers->count() > 0)
                                                @foreach ($project->teamMembers as $member)
                                                    @php $person = $member->member_type === 'admin' ? $member->admin : $member->employee;@endphp
                                                    <a href="{{ $person ? route('admin.employee.view', [$person->id]) : '#' }}"
                                                        class="d-flex gap-2 align-items-center">
                                                        <img style="height: 37px; width: 37px; border-radius: 50%; object-fit: cover; "
                                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($person?->image, asset('storage/app/public/admin/') . '/' . $person?->image, asset('public/assets/admin/img/160x160/img1.jpg'), 'admin/') }}"
                                                            alt="">
                                                        <p class="card-text font-weight-bold mb-0">
                                ...
                                @include('admin-views.form_modals.team_modal')
                            </div>
                        </div>
                    ...
                    @if (hasAnyPermission(['project_task.list', 'project_task.add']))
                        ...
                        <div class="tab-pane fade {{ request('tab') && request('tab') == 'tasks' ? 'show active' : '' }}"
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                @if (hasPermission('project_task', 'add'))
                                    <a href="{{ route('admin.project.task.add', [$project->id]) }}" type="button"
                                        class="btn btn-sm text-white" style="background-color: var(--primary);" \>
                            ...
                            @if (hasPermission('project_task', 'list'))
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    @if (hasPermission('project_task', 'view'))
                                                        <a href="{{ route('admin.project.task.detail', [$task->id]) }}"
                                                    ...
                                                    @if (hasPermission('project_task', 'delete'))
                                                        ...
                                                        <form
                                                            action="{{ route('admin.project.task.delete', [$task['id']]) }}"
                                ...
                                @if (hasPermission('project_task', 'add') && !count($tasks))
                                    <div class="w-100 d-flex align-items-center justify-content-center flex-column">
                                        No Tasks Yet..
                                        <a href="{{ route('admin.project.task.add', [$project?->id]) }}"
