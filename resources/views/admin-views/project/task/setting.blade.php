 ...
 @section('content')
     <div class="content container-fluid">
         ...
         <form class="w-100 p-0 " enctype="multipart/form-data" action="{{ route('admin.project.task.setting.update') }}"
             method="post">
             @csrf
             <div class="card mb-1">
                 <!-- Body -->
         ...
         <div class="">
             <div class="fb-main-container">
                 <div class="fb-content-area">
                     ...
                     <div class="fb-fields-list row" data-form="project_task_form" id="fbFormFields"></div>
 ...
 @push('script_2')
     ...
     @include('admin-views.js.form-builder')
 @endpush
