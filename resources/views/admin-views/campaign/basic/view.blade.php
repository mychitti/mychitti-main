            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-md-4 mb-3 mb-md-0">
                        <img class="rounded initial--5 onerror-image"
                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($campaign->image, asset('storage/app/public/campaign/') . '/' . $campaign->image, asset('public/assets/admin/img/160x160/img2.jpg'), 'campaign/') }}"
                        ...
                        @foreach ($stores as $key => $store)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <div class="btn--container justify-content-center">
                                            <a class="btn btn--danger btn-outline-danger action-btn form-alert"
                                                href="javascript:" data-id="campaign-{{ $store->id }}"
                                            ...
                                            <form
                                                action="{{ route('admin.campaign.remove-store', [$campaign->id, $store['id']]) }}"
