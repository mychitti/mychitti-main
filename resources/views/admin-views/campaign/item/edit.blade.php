                            ...
                            <div class="row g-2">
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="1" max="100000" step="0.001" value="{{$campaign->price}}" name="price" class="form-control"
...
@push('script_2')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            getStoreData('{{url('/')}}/store/get-addons?store_id={{$campaign['store_id']}}@foreach(json_decode($campaign['add_ons'], true) as $addon)&data[]={{$addon}}@endforeach','add_on');
            @else
            getStoreData('{{url('/')}}/store/get-addons?data[]=0&store_id={{$campaign['store_id']}}','add_on');
            @endif
        });
        ...
        $('#category_id').select2({
            ajax: {
                url: '{{url('/')}}/item/get-categories?parent_id=0',
                data: function (params) {
                    return {
                        q: params.term, // search term
                        page: params.page,
