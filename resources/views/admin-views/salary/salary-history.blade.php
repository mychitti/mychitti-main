        ...
        <div>
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a href="{{ route('admin.salary-history') }}" class="nav-link active">Salary History</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="{{ route('admin.advance-payment') }}" class="nav-link">Advance History</a>
                </li>
            </ul>
        </div>
                ...
                <div class="modal-body">
                    <form method='post' class="row" action="{{ route('admin.salary.advance-request.store') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="exampleInputEmail1" name="amount" placeholder="">
                            <small class="form-text text-muted">Must not be more than salary</small>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleCheck1">Required On <span class="text-danger">*</span></label>
                            <input type="date" name="required_on" min="{{ date('Y-m-d') }}" class="form-control" id="exampleCheck1">
                        </div>
