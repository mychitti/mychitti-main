...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="card w-100 p-0 col-md-9">
                <div class="card-body row py-0 align-items-start">
                    ...
                    <div class="form-row col-md-3 p-2">
                        ...
                        @php $emp_info = _getWhere('admins', ['id' => $salary->ven_id])[0]; @endphp
        ...
        <form class="w-100 p-0" action="{{ route('admin.salary.save') }}" method="post">
            @csrf
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('admin.salary.export', ['type' => 'excel', request()->getQueryString(), 'id' => $salary->ven_id]) }}">
...
@push('script_2')
    <script>
        ...
        $('#emp_select').on('change', function() {
            ...
            $.ajax({
                url: "{{ route('admin.salary.get-info') }}",
                type: 'POST',
                data: {
                    id: $('#emp_select').val()
                },
