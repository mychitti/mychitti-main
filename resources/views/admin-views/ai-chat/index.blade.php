    ...
    $.ajax({
     ...
     <script>
         ...
         function renderMessage(role, content, time = null) {
             let align = role === 'user' ? 'text-right' : 'text-left';
             let badge = role === 'user' ? 'badge-primary' : 'badge-success';
            ...
            <div class="mb-2 ${align}">
                ...
                <div style="white-space:pre-wrap"> ${role === 'user' ? 'You' : 'AI'}</div>
            </div>
        `;
         ...
         $('#clear-memory').on('click', function() {
             ...
             if (!confirm('Are you sure you want to clear all AI memory?')) {
                 return;
             }
