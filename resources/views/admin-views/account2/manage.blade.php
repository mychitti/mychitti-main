                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-row col-4">
                                ...
                                <input type="number" name="base_salary" required placeholder="Base Salary" class="form-control">
                            </div>
                            <div class="form-row col-4">
                            ...
                            <div class="form-row col-6">
                                ...
                                <input type="number" name="bonus_incentives"  placeholder="Bonus/Incentives" class="form-control">
                            </div>
                            <div class="form-row col-6">
                                <label for="exampleInputEmail1">Allowances</label>
                                <input type="number" name="allowance"  placeholder="Allowances" class="form-control">
                            </div>
                            <div class="form-row col-6">
                                <label for="exampleInputEmail1">Deductions</label>
                                <input type="number" name="deductions"  placeholder="Deductions" class="form-control">
                            </div>
                            <div class="form-row col-6">
