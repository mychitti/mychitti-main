                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <select id="deliveryman" name="deliveryman_id" data-placeholder="{{translate('messages.select_deliveryman')}}" data-url="{{url('/')}}/users/delivery-man/get-account-data/" data-type="deliveryman" class="form-control account-data" title="Select deliveryman">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input class="form-control" type="number" min="1" step="0.001" name="amount" id="amount" max="999999999999.99" placeholder="{{translate('ex_100')}}">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
...
<script>
    ...
    $('#deliveryman').select2({
        ajax: {
            url: '{{url('/')}}/users/delivery-man/get-deliverymen',
