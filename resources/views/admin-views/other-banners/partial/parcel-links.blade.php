<div class="d-flex flex-wrap justify-content-between align-items-center mb-5 __gap-12px">
    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('promotional-banner/add-new') || Request::is('promotional-banner/edit*') ? 'active' : '' }}"
                href="{{ route('admin.promotional-banner.add-new') }}">{{translate('messages.Promotional Banners')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('promotional-banner/add-video') ? 'active' : '' }}"
                href="{{ route('admin.promotional-banner.add-video') }}">{{translate('messages.video')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('promotional-banner/add-why-choose') ||  Request::is('promotional-banner/why-choose/edit*') ? 'active' : '' }}"
