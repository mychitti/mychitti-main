    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body  row">
                @if (Route::currentRouteName() == 'admin.staff.team.edit')
                    <div class="col-md-6">
                        <form action="{{ route('admin.staff.team.update') }}" method="post">
                            @csrf
                ...
                @endif
                <div class="{{ Route::currentRouteName() == 'admin.staff.team.edit' ? 'col-md-6' : 'col-md-12' }}">
                    <h3>Team Members</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($emp->employee?->image) 
                                            <img style="width:40px; height:40px;"
                                                src="{{ asset('storage/admin') . '/' . $emp->employee?->image }}"
                                    ...
                                    <td>
                                        ...
                                        @elseif(hasPermission('staff_team', 'edit'))
                                            ...
                                            <form action="{{ route('admin.staff.team.member.delete', [$emp['id']]) }}"
