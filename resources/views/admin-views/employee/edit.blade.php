                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @if( $imgs )
                                                        ...
                                                        <a class="m-2" style="cursor: zoom-in;" target="_blank" href="{{  asset('storage/app/public/admin/emp_documents/').'/'.$value }}"><img src="{{  asset('storage/app/public/vendor/documents/').'/'.$value }}" alt="" width="100px" style="height: 100px ; object-fit:cover;"><br>Image</a>
                                                        @else 
                                                        <a class="m-2"  target="_blank" href="{{  asset('storage/app/public/admin/emp_documents/').'/'.$value }}"><div style="width : 100px; border : 1px solid grey ; height: 100px ; object-fit:cover;" class="d-flex align-items-center justify-content-center">file</div> File</a>
                                                        @endif
                                                        @endforeach
                                                   @endif
                                                   </div>
