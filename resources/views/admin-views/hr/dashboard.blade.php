                    ...
                    <div class="team-section">
                        <div class="d-flex justify-content-between">
                            ...
                            @if (hasPermission('staff_manage', 'list'))
                                <a href="{{ route('admin.users.employee.list') }}">view all</a>
                            @endif
                        </div>
                                ...
                                <div class="team-member d-flex justify-content-between">
                                    <div class="d-flex justify-content-start">
                                        <div class="member-avatar mr-2">
                                          <a type="button" data-toggle="modal"
                                            ...
                                            <img class="member-img onerror-image onerror-image"
                                                data-onerror-image="{{ asset('public/assets/admin/img/160x160/img2.jpg') }}"
                                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper($value->image, asset('storage/app/public/admin/') . '/' . $value->image, asset('public/assets/admin/img/160x160/img2.jpg'), 'admin/') }}"
                                                alt="Logo">
</a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            @include('admin-views.form_modals.id_card')
                                                        </div>
                                    ...
                                    <div>
                                        @if (hasPermission('staff_manage', 'view'))
                                            <a href="{{ route('admin.employee.view', [$value->id]) }}"
            ...
            <div class="right-section">
                ...
                <div class="updates-section">
                    ...
                    @if (hasPermission('salary_manage', 'advance_requests'))
                        <a href="{{ route('admin.salary.all-advance-requests') }}" class="text-underline">View All</a>
                    @endif
                </div>
                <div class="updates-section">
                    <div class="updates-header">
                ...
                <div class="week-schedule">
                    <div class="schedule-row fri">
                        ...
                        <div>
                            @if (hasPermission('staff_manage', 'list'))
                                <a href="{{ route('admin.users.employee.list') }}" class="btn btn-primary">-></a>
                            @endif
                        </div>
                    </div>
                    <div class="schedule-row mon">
                        ...
                        <div>
                            @if (hasPermission('leave_manage', 'list'))
                                <a href="{{ route('admin.leave.all') }}" class="btn btn-primary">-></a>
                            @endif
                        </div>
                    </div>
                    <div class="schedule-row wed">
                        ...
                        <div>
                            @if (hasPermission('task_manage', 'list'))
                                <a href="{{ route('admin.task.list') }}" class="btn btn-primary">-></a>
                            @endif
                        </div>
                                            ...
                                            <td>
                                                @if ($value->status == 'pending')
                                                    <div class="btn--container">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.employee.resignation-action', [$value->id, 'approved']) }}"
                                                        ...
                                                        <form
                                                            action="{{ route('admin.employee.resignation-action', [$value->id, 'rejected']) }}"
