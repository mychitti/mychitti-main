...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.blog.save') }}" id="blog_form" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-8 row">
                            ...
                            <div class="form-group lang_form col-md-6" id="default-form">
                                ...
                                <select name="category" id="category_select" class="form-control js-select2-custom">
                            ...
                            <div class="form-group lang_form col-12" id="default-form">
                                <label class="input-label" for="exampleFormControlInput1">Title <span
                                        class="form-label-secondary text-danger" data-toggle="tooltip"
                                        data-placement="right" data-original-title="{{ translate('messages.Required.') }}">
                                        *
                                    </span>
                            ...
                            <div class="form-group lang_form col-12" id="default-form2">
                                <label class="input-label" for="exampleFormControlInput2">Short Description<span
                                        class="form-label-secondary text-danger">
                                    </span>
                                </label>
                                <textarea placeholder="Short Description" class="form-control" name="short_description" id=""></textarea>
                            </div>
                            <div class="form-group lang_form col-12" id="default-form2">
                                <label class="input-label" for="exampleFormControlInput2">Description<span
                                        class="form-label-secondary text-danger" data-toggle="tooltip"
                                        data-placement="right" data-original-title="{{ translate('messages.Required.') }}">
                                        *
                                    </span>
