            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div class="d-flex gap-2 align-items-center">
                        <img src="{{ asset('public/assets/admin/img/icons/coupon-icon.png') }}" width="16"
                            height="16" alt="">
                        <p class="mb-0">
                            {{ translate('If you want to make a customized COUPON for this customer, click the Create Coupon button and influence them buy more from your store.') }}
                        </p>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-3">
                            <div
                                class="color-card flex-column align-items-center justify-content-center color-2 flex-grow-1">
                                <div class="img-box">
                                    <img class="resturant-icon w--30"
                                        src="{{ asset('/public/assets/admin/img/icons/order-icon-1.png') }}" alt="">
                                </div>
                            ...
                            <div
                                class="color-card flex-column align-items-center justify-content-center color-5 flex-grow-1">
                                <div class="img-box">
                                    <img class="resturant-icon w--30"
                                        src="{{ asset('/public/assets/admin/img/icons/order-icon-2.png') }}"
                                        alt="">
                                </div>
                                <div class="d-flex flex-column align-items-center">
                                    <h2 class="title">
                                        {{ \App\CentralLogics\Helpers::format_currency($total_order_amount[0]->total_order_amount) }}
                                    </h2>
                                    <div class="subtitle">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-3">
                            <div
                                class="color-card flex-column align-items-center justify-content-center color-7 flex-grow-1">
                                <div class="img-box">
                                    <img class="resturant-icon w--30"
                                        src="{{ asset('/public/assets/admin/img/icons/order-icon-3.png') }}"
                                        alt="transactions">
                                </div>
                                <div class="d-flex flex-column align-items-center">
                            ...
                            <div
                                class="color-card flex-column align-items-center justify-content-center color-4 flex-grow-1">
                                <div class="img-box">
                                    <img class="resturant-icon w--30"
                                        src="{{ asset('/public/assets/admin/img/icons/order-icon-4.png') }}"
                                        alt="transactions">
                                </div>
                                <div class="d-flex flex-column align-items-center">
                                ...
                                <form class="search-form theme-style">
                                    <div class="input-group input--group">
                                        <input type="search" name="search" class="form-control"
                                            placeholder="{{ translate('ex_: search_by_order_id') }}"
                        ...
                        <div class="hs-unfold mr-2">
                            ...
                            <div id="usersExportDropdown"
                                ...
                                <a id="export-excel" class="dropdown-item"
                                    href="{{ route('admin.customer.order-export', ['type' => 'excel', 'id' => $customer->id, request()->getQueryString()]) }}">
                                ...
                                <a id="export-csv" class="dropdown-item"
                                    href="{{ route('admin.customer.order-export', ['type' => 'csv', 'id' => $customer->id, request()->getQueryString()]) }}">
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                <a class="btn action-btn btn--primary btn-outline-primary" target="_blank"
                                                    ...
                                                    title="{{ translate('messages.download') }}">
                    ...
                    <div class="card-header border-0 py-2 d-flex flex-wrap gap-2">
                        <div class="search--button-wrapper">
                            <h5 class="card-title d-flex gap-2 align-items-center">
                                ...
                                <span class="badge badge-soft-secondary">{{ count($services) }}</span>
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    <th class="border-0 pl-4">{{ translate('SL') }}</th>
                                    <th class="border-0">{{ translate('messages.service_name') }}</th>
                                    <th class="border-0">{{ translate('messages.store') }}</th>
                                    <th class="border-0 ">{{ translate('messages.status') }}</th>
                                    {{-- <th class="border-0 ">{{ translate('messages.total_amount') }}</th> --}}
                                ...
                                @foreach ($services as $key => $order)
                                    <tr>
                                        ...
                                        <th>
                                            @if ($order->vendor_id)
                                                <div><a class="text--title"
                                                        href="{{ route('admin.store.view', $order->vendor_id) }}"
                                                        alt="view store">{{ $order->vendor_id && _getUserDetails($order->vendor_id, 'store') ?  Str::limit(_getUserDetails($order->vendor_id, 'store')->name, 20, '...') : translate('messages.store deleted!') }}</a>
                                                </div>
                                            @else
                                                <div>{{ Str::limit(translate('messages.not_found'), 20, '...') }}</div>
                                            @endif
                                        ...
                                        <td>
                                            <div>
                                                <div>
                                                    {{ \App\CentralLogics\Helpers::date_format($order->updated_at) }}
                                                </div>
                                                <div class="d-block text-uppercase">
                                                    {{ \App\CentralLogics\Helpers::time_format($order->updated_at) }}
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--warning btn-outline-warning"
                                                    href="{{ route('admin.service.lead-detail', ['id' => $order->service_id]) }}"
                                                    title="{{ translate('messages.view') }} "><i
                                                        class="tio-visible"></i></a>
                                                </a>
                                            </div>
                ...
                <div class="card my-2">
                    <div class="card-header border-0 py-2 d-flex flex-wrap gap-2">
                        <div class="search--button-wrapper">
                            <h5 class="card-title d-flex gap-2 align-items-center">
                                Items in Wishlist
                                <span class="badge badge-soft-secondary">{{ count($productWishlist) }}</span>
                            </h5>
                        </div>
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="border-0">Since</th>
                                    <th class="border-0">Action</th>
                                </tr>
                            </thead>

                            <tbody>
                                @foreach ($productWishlist as $key => $item)
                                    <tr>
                                        <td>
                                            <div class="pl-2">
                                                {{ $key + 1 }}
                                        ...
                                        <td>
                                            <img class="onerror-image rounded" style="width: 50px; height:50px"
                                        ...
                                        <td>{{ _formatted_date($item->created_at) }}</td>
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--warning btn-outline-warning"
                                                    href="{{ route('admin.item.view', [$item->item_id]) }}"
                                                    title="{{ translate('messages.view') }} "><i
                                                        class="tio-visible"></i></a>
                ...
                <div class="card">
                    <div class="card-header border-0 py-2 d-flex flex-wrap gap-2">
                        <div class="search--button-wrapper">
                            <h5 class="card-title d-flex gap-2 align-items-center">
                                Stores in Wishlist
                                <span class="badge badge-soft-secondary">{{ count($storeWishlist) }}</span>
                            </h5>
                        </div>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tbody>
                                @foreach ($storeWishlist as $key => $item)
                                    <tr>
                                        <td>
                                            <div class="pl-2">
                                                {{ $key + 1 }}
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--warning btn-outline-warning"
                                                    href="{{ route('admin.store.view', [$item->id]) }}"
                                                    title="{{ translate('messages.view') }} "><i
                                                        class="tio-visible"></i></a>
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title d-flex flex-wrap align-items-center gap-2">
                            ...
                            <span class="badge badge-soft-info">{{ translate('total_order') }}:
                                {{ $orders->total() }}</span>
                        </h4>
                    </div>
                    <!-- End Header -->
                        ...
                        <div class="card-body">
                            <div class="media gap-3 flex-wrap">
                                <div class="avatar avatar-circle avatar-70">
                                    <img class="avatar-img onerror-image" width="70" height="70"
                                ...
                                <div class="media-body">
                                    <div class="key-value-list d-flex flex-column gap-2 text-dark"
                                        ...
                                        <div class="key-val-list-item d-flex gap-3">
                                            <div>{{ translate('contact') }}</div>:
                                             ...
                                             <a href="javascript:;" style="cursor:default;"
                                               class="text-dark font-semibold textToCopy" >{{ $customer['phone'] }}</a>
                                            <button
                                        ...
                                        <div class="key-val-list-item d-flex gap-3">
                                            ...
                                            <a href="mailto:{{ $customer['email'] }}"
                                                class="text-dark font-semibold">{{ $customer['email'] }}</a>
                                        </div>
                                        @foreach ($customer->addresses as $address)
                                            <div class="key-val-list-item d-flex gap-3">
                                                <div>{{ translate('address') }}</div>:
                                                <a href="https://www.google.com/maps/search/?api=1&query={{ data_get($address, 'latitude', 0) }},{{ data_get($address, 'longitude', 0) }}"
