             ...
             <div class="d-flex flex-wrap px-3 w-100">
                 <div class="d-flex w-100 flex-wrap justify-content-between  align-orders-center">
                     ...
                     <div class="d-flex gap-1">
                         <a href="{{ route('admin.library.gatepass.add', ['purchase']) }}" class="btn btn-primary">+ Purchase
                             Gatepass</a>
                         <a href="{{ route('admin.library.gatepass.add', ['sale']) }}" class="btn btn-primary">+ Sale
                             Gatepass</a>
                     </div>
                 </div>
             </div>
                         ...
                         @foreach ($gatepass as $key => $gp)
                             <tr>
                                 ...
                                 <td>
                                     @if ($type !== 'return-gp')
                                         @if (!$gp->returned)
                                             <a href="{{ route('admin.inventory.gatepass.return', [$gp->id]) }}"
                                         ...
                                         <div class="dropdown">
                                             ...
                                             <div class="dropdown-menu">
                                                 ...
                                                 <form action="{{ route('admin.documents.gatepass.delete', [$gp->id]) }}"
 ...
 @push('script_2')
     <script>
         ...
         $("#download_selected").on('click', function() {
             ...
             var form = $('<form>', {
                 action: '{{ route('admin.inventory.report.purchase', ['export', 'excel']) }}',
                 method: 'GET'
             });
