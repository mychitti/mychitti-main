...
@section('content')
    <div class="p-3">
        <div class="header d-flex align-items-center gap-2 justify-content-between">
            ...
            <a href="{{ route('admin.inventory.edit-item', [$item->id]) }}" class="btn btn-outline-primary"><i
                    ...
                    @if ($item->barcode || $item->sku_id)
                        ...
                        <div class="d-flex gap-2">
                            <a style="padding: 10px 8px;white-space: nowrap;"
                                href="{{ route('admin.inventory.item.print', [$item->id, 'barcode']) }}"
                                class="btn btn-sm btn--primary"><i class="tio-print"></i> Print Barcode</a>
                            <a style="padding: 10px 8px;white-space: nowrap;"
                                href="{{ route('admin.inventory.item.print', [$item->id, 'description']) }}"
                                class="btn btn-sm btn--primary"><i class="tio-print"></i> Print
                                Description</a>
                            <a style="padding: 10px 8px;white-space: nowrap;"
                                href="{{ route('admin.inventory.item.print', [$item->id, 'full']) }}"
                                ...
                                <td>
                                    <div class="btn--container justify-content-warning">
                                        ...
                                        @if (hasPermission('inventory_item', 'delete'))
                                            ...
                                            <form action="{{ route('admin.inventory.item.delete-variation') }}"
