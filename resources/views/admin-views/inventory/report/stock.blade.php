 ...
 @push('script_2')
     <script>
         ...
         $("#download_selected").on('click', function() {
             ...
             var form = $('<form>', {
                 action: '{{ route('admin.inventory.report.stock', ['export', 'excel']) }}',
                 method: 'GET'
             });
