             ...
             <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 p-2">
                 ...
                 <div class="d-flex gap-1 flex-wrap">
                     ...
                     @if (hasPermission('sale_report', 'export'))
                         ...
                         <a href="{{ route('admin.inventory.report.sale', ['export', 'pdf']) }}"
                             ...
                             Pdf</a>
                         <a href="{{ route('admin.inventory.report.sale', ['export', 'excel']) }}"
                             class="btn text-dark border border-dark btn-outline-light">
                                         ...
                                         <div class="dropdown">
                                             ...
                                             <div class="dropdown-menu">
                                                 @if (in_array($invoice->payment_status, ['unpaid', 'Unpaid']))
                                                     ...
                                                     <form
                                                         action="{{ route('admin.invoice.mark-paid', ['manual', $invoice->id]) }}"
 ...
 @push('script_2')
     <script>
         ...
         $("#download_selected").on('click', function() {
             ...
             var form = $('<form>', {
                 action: '{{ route('admin.inventory.report.sale', ['export', 'excel']) }}',
                 method: 'GET'
             });
