             ...
             <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 p-2">
                 ...
                 @if(hasPermission('profit_loss_summary', 'export'))
                     ...
                     <div class="d-flex gap-2">
                         <a href="{{ route('admin.inventory.report.profit-and-loss', ['export', 'pdf']) }}"
                             ...
                             Pdf</a>
                         <a href="{{ route('admin.inventory.report.profit-and-loss', ['export', 'excel']) }}"
                             class="btn text-dark border border-dark btn-outline-light">
                     ...
                     <tbody id="">
                         @foreach ($orderItems as $key => $orderItem)
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <div style="">
                                         <a href="{{ route('admin.inventory.item.detail', [$orderItem->item_id]) }}">
                                     ...
                                     <div class="dropdown">
                                         ...
                                         <div class="dropdown-menu">
                                             <a class="dropdown-item text-success"
                                                 href="{{ route('admin.inventory.item.detail', [$orderItem->item_id]) }}"
