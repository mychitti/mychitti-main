        ...
        @if (hasPermission('inventory_purchase_return', 'add'))
            <div class=" p-2">
                <div class="pox-wrap p-0">
                    ...
                    <form action="{{ route('admin.inventory.purchase.return-store') }}" method="post">
                        @csrf
                        <main class="pox-grid">
                            <section>
                                <div class="pox-card">
...
@push('script_2')
    <script>
        ...
        $("#customer_id").on('change', function() {
            ...
            $.ajax({
                url: "{{ route('admin.billing.get-invoices-by-vendor') }}",
                type: 'POST',
                data: {
                    vendor_id: vendor_id
                },
        ...
        $('#invoice_id').on('change', function() {
            ...
            $.ajax({
                url: "{{ route('admin.inventory.purchase.items-in-invoice') }}",
                data: {
