                ...
                <div class="d-flex w-100 flex-wrap justify-content-between  align-items-center">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        @if (hasPermission('inventory_sale_order', 'export'))
                            <a href="{{ route('admin.inventory.sale.order-export') }}"
                                    ...
                                    <td>
                                        @if ($item->item?->id)
                                            <div style="width: 300px;text-align: start !important;white-space: normal;">
                                                ...
                                                <a href="{{ route('admin.inventory.item.detail', [$item->item?->id]) }}">
                                            ...
                                            <div class="dropdown-menu">
                                                @if (hasPermission('inventory_sale', 'status_change'))
                                                    @if ($item->status != 'completed')
                                                        ...
                                                        <form
                                                            action="{{ route('admin.inventory.sale.order-status', [$item->id, 'completed']) }}"
                                                    ...
                                                    @if ($item->status != 'returned')
                                                        ...
                                                        <form
                                                            action="{{ route('admin.inventory.sale.order-status', [$item->id, 'returned']) }}"
                                                    ...
                                                    @if ($item->status != 'cancelled')
                                                        ...
                                                        <form
                                                            action="{{ route('admin.inventory.sale.order-status', [$item->id, 'cancelled']) }}"
