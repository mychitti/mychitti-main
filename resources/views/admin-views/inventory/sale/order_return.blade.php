            ...
            <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex gap-2 flex-wrap py-2 px-1">
                    ...
                    @if (hasPermission('inventory_sale_return', 'export'))
                        <a href="{{ route('admin.inventory.sale.order-export', ['return']) }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="width: 300px;text-align: start !important;white-space: normal;">
                                        <a href="{{ $detail->item?->id ? route('admin.inventory.item.detail', [$detail->item?->id]) : '#' }}">
...
@push('script_2')
    <script>
        $('#order_select').on('change', function() {
            ...
            $.ajax({
                url: "{{ route('admin.inventory.sale.order-details-fetch') }}",
                data: {
                    order_id: $(this).val()
                },
                type: 'post',
