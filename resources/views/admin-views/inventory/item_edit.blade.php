    ...
    <div class="content container-fluid">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form enctype="multipart/form-data" class="w-100"
                                action="{{ route('admin.inventory.item.variation-store') }}" method="post">
                                @csrf
        ...
        <div class="row g-2">
            <form class="customer_add_form " id="item_form" enctype="multipart/form-data" class="w-100"
                action="{{ route('admin.inventory.item.update') }}" method="post">
                @csrf
                ...
                <div class="custom-form-wrapper">
                    ...
                    <div class="custom-tabs-wrapper">
                        <ul class="nav nav-tabs" id="itemTabs" role="tablist">
                            ...
                            <li class="nav-item product_elem">
                                <a class="nav-link" id="product-info-tab" data-toggle="tab" href="#product-info"
                                    role="tab">
                                                ...
                                                @foreach ($item->images as $key => $photo)
                                                    <div style="max-width: 70px !important; margin: 5px;"
                                                        ...
                                                        <img class="img--square onerror-image"
                                                            ...
                                                            alt="Item image">
                                                        <a href="{{ route('admin.inventory.item.remove-image', [$item['id'], $photo]) }}"
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-12">
                                            <div class="customer_choice_options" id="customer_choice_options">
                                                @include('admin-views.inventory._choices', [
                                        ...
                                        <div class="col-md-12">
                                            <div class="variant_combination" id="variant_combination">
                                                @include('admin-views.inventory._edit-combinations', [
