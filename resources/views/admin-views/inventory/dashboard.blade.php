                    ...
                    <div class="card-body">
                        <div class="d-flex row col-12 g-0 justify-content-between stat-bar">
                            <div class="col-md-3 stat-bard-card">
                                <a href="{{ route('admin.inventory.index') }}?type=product" class="stat-block ">
                            ...
                            <div class="col-md-3 stat-bard-card">
                                <a href="{{ route('admin.inventory.index') }}?type=service" class="stat-block ">
                    ...
                    <div class="card-body">
                        <div class="space-y-3">
                            ...
                            <div class="plasma-item p-3 mb-3">
                                <a href="{{ route('admin.inventory.index') }}?filter=low_stock&type=product"
                            ...
                            <div class="plasma-item p-3 mb-3">
                                <a href="{{ route('admin.inventory.index') }}?type=product"
                                    class="d-flex align-items-center">
                            ...
                            <div class="col-12 mb-3">
                                <a href="{{ route('admin.inventory.index') }}?filter=low_stock&type=service"
                            ...
                            <div class="col-12 mb-3">
                                <a href="{{ route('admin.inventory.index') }}?type=service"
                                    class="d-flex align-items-center justify-content-between p-3 bg-light rounded-3">
                                    <div class="d-flex align-items-center">
                    ...
                    <div class="card-body">
                        <div class="space-y-3">
                            @foreach ($data['top_sell'] as $key => $item)
                                <!-- Two Wheeler Accessories -->
                                <div class="plasma-item p-3 mb-3">
                                    <a href="{{ $item->item?->id ? route('admin.inventory.item.detail', [$item->item?->id]) : '#'}}" class="d-flex align-items-center">
                    ...
                    <div class="col-md-8">
                        <div class="card card-soft">
                            <div class="card-header bg-pastel-pink fw-bold d-flex justify-content-between">
                                ...
                                <a href="{{ route('admin.inventory.index') }}?tab=entry" class=" ">View all</a>
                            </div>
                                    ...
                                    <tbody id="set-rows">
                                        @foreach ($data['entries'] as $key => $entry)
                                            <tr class="clickable-row"
                                                onclick="window.location='{{ route('admin.inventory.item.detail', [$entry->item?->id ?? 0]) }}'">
