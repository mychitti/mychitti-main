            ...
            <div class="w-100 d-flex flex-wrap justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1 flex-wrap flex-md-nowrap ">
                    ...
                    @if (hasPermission('boa_monthly_maintenance', 'export'))
                        <a href="{{ route('admin.account.maintenance.export') }}" class="btn btn_sm btn-outline-primary ">
                            Export
                        </a>
                    @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                @if (hasPermission('boa_monthly_maintenance', 'delete'))
                                                    <form
                                                        action="{{ route('admin.account.maintenance.delete', [$e['id']]) }}"
                                                            ...
                                                            @if ($e['due'])
                                                                @if (hasPermission('boa_monthly_maintenance', 'edit'))
                                                                    <a class="dropdown-item text-primary"
                                                                        href="{{ route('admin.account.maintenance.mark-paid', [$e['id']]) }}"
                                                                        title="Mark Paid"><i class="tio-edit"></i> Mark
                                                                        Paid
                                                                    </a>
                                                                    <a class="dropdown-item text-warning"
                                                                        href="{{ route('admin.account.maintenance.status', [$e['id'], 'hold']) }}"
                                                                        title="Hold"><i class="tio-pause"></i> Hold
                                                                    </a>
                                                                    <a class="dropdown-item text-danger"
                                                                        href="{{ route('admin.account.maintenance.status', [$e['id'], 'cancel']) }}"
                ...
                <div class="modal-body">
                    ...
                    <p style="margin-top:12px; color:#555; font-size:0.85rem;">
                        ...
                        Paid”. You can configure this in the <a class="text-underline"
                            href="{{ route('admin.account.setting.common-settings') }}">Settings Page</a>
                    </p>
                </div>
        ...
        <div class="modal fade" id="importExcelModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.account.maintenance.import') }}" method="post"
        ...
        <div class="modal fade" id="addExpenseModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('admin.account.maintenance.store') }}">
                        @csrf
                        <div class="modal-body">
        ...
        <div class="modal fade" id="mmSettingsModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('admin.business-settings.config.save') }}">
                        @csrf
                        <div class="modal-body">
        ...
        <div class="modal fade" id="editExpenseModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('admin.account.maintenance.update') }}">
                        @csrf
                        <div class="modal-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.save-price').click(function() {
                ...
                $.ajax({
                    url: "{{ route('admin.account.maintenance.update-entry-price') }}", // your route
                    method: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: id,
