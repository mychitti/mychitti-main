...
{{$lead->service_name}}
                            ...
                            <td>
                            <form id="status-form{{$lead->id}}" method="post" action="{{route('admin.lead.status-change')}}">
                                @csrf
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="btn  btn--warning btn-outline-warning"
                                            href="{{ route('admin.lead.manage', [$lead->id]) }}"
                                            title="{{ translate('messages.view') }}">Manage
                                        </a>
                              
                                    <a style="min-width:50px;" class="btn  btn--danger btn-outline-danger" href="{{ route('admin.lead.delete', [$lead->id]) }}"
