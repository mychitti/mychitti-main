    ...
    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.react-landing-page-settings.get', 'header') }}">{{translate('Header')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/pages/react-landing-page-settings/company-intro') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.react-landing-page-settings.get', 'company-intro') }}">{{translate('Company Intro')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/pages/react-landing-page-settings/download-user-app') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.react-landing-page-settings.get', 'download-user-app') }}">{{translate('Download User App')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/pages/react-landing-page-settings/earn-money') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.react-landing-page-settings.get', 'earn-money') }}">{{translate('messages.earn_money')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/pages/react-landing-page-settings/promotion-banner') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.react-landing-page-settings.get', 'promotion-banner') }}">{{translate('Promotional Banners')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/pages/react-landing-page-settings/business-section') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.react-landing-page-settings.get', 'business-section') }}">{{translate('Business Section')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/pages/react-landing-page-settings/testimonials*') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.react-landing-page-settings.get', 'testimonials') }}">{{translate('messages.testimonials')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/pages/react-landing-page-settings/fixed-data*') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.react-landing-page-settings.get', 'fixed-data') }}">{{translate('messages.fixed_Data')}}</a>
            </li>
        </ul>
        <!-- End Nav -->
    </div>
