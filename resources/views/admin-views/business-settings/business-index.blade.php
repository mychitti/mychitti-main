        ...
        <form action="{{ route('admin.business-settings.update-setup') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    @php($cin_number = \App\Models\BusinessSetting::where('key', 'cin_number')->first())
                                    <div class="form-group mb-0">
                                        <label class="form-label"
                                            for="cin_number">{{ translate('messages.cin_number') }}</label>
                                        <input id="cin_number" type="text" value="{{ $cin_number->value ?? '' }}"
                                            name="cin_number" class="form-control"
                                            placeholder="{{ translate('messages.Ex_:_T62099HP2113PTD155419') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-md-6">
                                    <div class="row g-3">
                                        <div class="col-sm-12">
                                            @php($gst = \App\Models\BusinessSetting::where('key', 'gst_number')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label"
                                                    for="gst_number">{{ translate('messages.GST') }}</label>
                                                <input id="gst_number" type="text" value="{{ $gst->value ?? '' }}"
                                                    name="gst_number" class="form-control"
                                                    placeholder="{{ translate('messages.GST_number') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" id="address" name="address" class="form-control h--90px"
                                                    placeholder="{{ translate('messages.Ex: address') }}" rows="1" required>{{ $address->value ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="d-flex __gap-12px mt-4">
                                        <div class="__custom-upload-img mr-lg-5">
                                            ...
                                            @php($logo = $logo->value ?? '')
                                            <label class="form-label">
                                                {{ translate('logo') }} <span class="text--primary">(
                                                    {{ translate('3:1') }} )</span>
                                            </label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select id="timezone" name="timezone" class="form-control js-select2-custom">
                                            ...
                                            <option value="US/Alaska"
                                                {{ $tz ? ($tz == 'US/Alaska' ? 'selected' : '') : '' }}>(GMT-09:00)Alaska
                                            </option>
                                            ...
                                            <option value="US/Arizona"
                                                {{ $tz ? ($tz == 'US/Arizona' ? 'selected' : '') : '' }}>(GMT-07:00)Arizona
                                            </option>
                                            ...
                                            <option value="US/Central"
                                                {{ $tz ? ($tz == 'US/Central' ? 'selected' : '') : '' }}>(GMT-06:00)Central
                                            ...
                                            <option value="US/Eastern"
                                                {{ $tz ? ($tz == 'US/Eastern' ? 'selected' : '') : '' }}>(GMT-05:00)Eastern
                                                Time (US & Canada)</option>
                                            ...
                                            <option value="Asia/Amman"
                                                {{ $tz ? ($tz == 'Asia/Amman' ? 'selected' : '') : '' }}>(GMT+02:00)Amman
                                            </option>
                                            <option value="Europe/Athens"
                                                {{ $tz ? ($tz == 'Europe/Athens' ? 'selected' : '') : '' }}>
                                                (GMT+02:00) Athens, Bucharest, Istanbul</option>
                                            <option value="Asia/Beirut"
                                                {{ $tz ? ($tz == 'Asia/Beirut' ? 'selected' : '') : '' }}>(GMT+02:00)Beirut
                                            </option>
                                            ...
                                            <option value="Asia/Muscat"
                                                {{ $tz ? ($tz == 'Asia/Muscat' ? 'selected' : '') : '' }}>(GMT+04:00)Abu
                                                Dhabi,Muscat</option>
                                            <option value="Asia/Baku"
                                                {{ $tz ? ($tz == 'Asia/Baku' ? 'selected' : '') : '' }}>(GMT+04:00)Baku
                                            </option>
                                            <option value="Asia/Yerevan"
                                                {{ $tz ? ($tz == 'Asia/Yerevan' ? 'selected' : '') : '' }}>
                                                (GMT+04:00) Yerevan</option>
                                            <option value="Asia/Kabul"
                                                {{ $tz ? ($tz == 'Asia/Kabul' ? 'selected' : '') : '' }}>(GMT+04:30)Kabul
                                            </option>
                                            ...
                                            <option value="Asia/Tokyo"
                                                {{ $tz ? ($tz == 'Asia/Tokyo' ? 'selected' : '') : '' }}>(GMT+09:00)Osaka,
                                                Sapporo, Tokyo</option>
                                            <option value="Asia/Seoul"
                                                {{ $tz ? ($tz == 'Asia/Seoul' ? 'selected' : '') : '' }}>(GMT+09:00)Seoul
                                            </option>
                                        ...
                                        <div class="resturant-type-group border">
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="left"
                                                    ...
                                                    {{ $currency_symbol_position ? ($currency_symbol_position->value == 'left' ? 'checked' : '') : '' }}>
                                            ...
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="right"
                                                    name="currency_symbol_position"
                                                    {{ $currency_symbol_position ? ($currency_symbol_position->value == 'right' ? 'checked' : '') : '' }}>
                                                <span class="form-check-label">
                                                    {{ translate('Right') }} ($)
                                                </span>
                                            </label>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    @php($meta_title = \App\Models\BusinessSetting::where('key', 'meta_title')->first())
                                    <div class="form-group mb-0">
                                        <label class="form-label" for="cookies_text">Meta Title
                                        </label>
                                        <textarea type="text" id="meta_title" name="meta_title" class="form-control h--45" placeholder="Meta Title">{{ $meta_title->value ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4 col-xl-4">
                                    @php($meta_description = \App\Models\BusinessSetting::where('key', 'meta_description')->first())
                                    <div class="form-group mb-0">
                                        <label class="form-label" for="cookies_text">Meta Description
                                        </label>
                                        <textarea type="text" id="meta_description" name="meta_description" class="form-control h--45"
                                            placeholder="Meta Description">{{ $meta_description->value ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4 col-xl-4">
                                    @php($meta_keywords = \App\Models\BusinessSetting::where('key', 'meta_keywords')->first())
                                    <div class="form-group mb-0">
                                        <label class="form-label" for="cookies_text">Meta Keywords
                                        </label>
                                        <textarea type="text" id="meta_keywords" name="meta_keywords" class="form-control h--45"
                                            placeholder="Meta Keywords">{{ $meta_keywords->value ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                            ...
                                            <span class="toggle-switch toggle-switch-sm pr-sm-3">
                                                <input type="checkbox" data-id="free_delivery_over_status"
                                                    data-type="toggle"
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <input type="checkbox" data-id="partial_payment" data-type="toggle"
                                                        ...
                                                        class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1" name="partial_payment_status" id="partial_payment"
                                                ...
                                                <div class="resturant-type-group border bg-white">
                                                    <label class="form-check form--check">
                                                        <input class="form-check-input" type="radio" value="cod"
                                                            ...
                                                            {{ $partial_payment_method ? ($partial_payment_method->value == 'cod' ? 'checked' : '') : '' }}>
                                                        <span class="form-check-label">
                                                            {{ translate('cod') }}
                                                        </span>
                                                    </label>
                                                    ...
                                                    <label class="form-check form--check">
                                                        <input class="form-check-input" type="radio" value="both"
                                                            name="partial_payment_method"
                                                            {{ $partial_payment_method ? ($partial_payment_method->value == 'both' ? 'checked' : '') : '' }}>
                                                        <span class="form-check-label">
                                                            {{ translate('both') }}
                                                        </span>
                                                    </label>
                ...
                <div class="col-lg-12">
                    <h4 class="card-title mb-3 d-flex align-items-center"> <span class="card-header-icon mr-2"><i
                                class="tio-neighborhood"></i></span>
                        <span>{{ translate('messages.invoice_setup') }} </span>
                    </h4>
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                <div class="col-md-3 mb-3">
                                    <div class="flex-grow-1 mx-auto">
                                        <div class="__custom-upload-img">
                                            ...
                                            <label class="text-center position-relative">
                                                <img class="img--133 onerror-image image--border" id="signUploadViewer"
                                                    data-onerror-image="{{ asset('public/assets/admin/img/upload-img.png') }}"
                                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($sign, asset('storage/app/public/business/') . '/' . $sign, asset('public/assets/admin/img/upload-img.png'), 'business/') }}"
                                                    alt="Fav icon" />
                                                <div class="icon-file-group">
                                                    <div class="icon-file">
                                                        <input type="hidden" class="sign_status" name="sign_status"
                                                            value = "{{ $sign ? 'uploaded' : 'not_uploaded' }}">
                                                        <input type="file" name="admin_signature" id="signUpload"
                                                            class="custom-file-input"
                                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                                        <i class="tio-edit"></i>
                                                    </div>
                                                    <button type="button"
                                                        class="reset_sign_upload btn action-btn btn-outline-danger">
                                                        <i class="tio-delete-outlined"></i>
                                                    </button>
                                                </div>
