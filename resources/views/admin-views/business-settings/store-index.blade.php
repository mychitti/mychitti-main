                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    @php($min_balance_notif = \App\Models\BusinessSetting::where('key', 'min_balance_notif')->first())
                                    @php($min_balance_notif = $min_balance_notif ? $min_balance_notif->value : 'weekly')

                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize d-flex alig-items-center"><span
                                                class="line--limit-1">{{ translate('messages.Low balace notification') }}
                                            </span><span class="input-label-secondary text--title" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ translate('messages.Average balance will be calculated to send minimum balance notification to vendors.') }}">
                                                <i class="tio-info-outined"></i>
                                            </span></label>
                                        <div class="restaurant-type-group border">
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="monthly"
                                                    name="min_balance_notif" id="min_balance_notif"
                                                    {{ $min_balance_notif == 'monthly' ? 'checked' : '' }}>
                                                <span class="form-check-label">
                                                    Monthly
                                                </span>
                                            </label>
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="weekly"
                                                    name="min_balance_notif" id="min_balance_notif2"
                                                    {{ $min_balance_notif == 'weekly' ? 'checked' : '' }}>
                                                <span class="form-check-label">
                                                    Weekly
                                                </span>
                                            </label>
                                ...
                                <div class="justify-content-between border form-control">
                                    <div class="form-check form-check-inline mx-4  ">
                                        <input class="mx-2 form-check-input" type="checkbox"
                                            {{ data_get($product_approval_datas, 'Add_new_product', null) == 1 ? 'checked' : '' }}
                                            id="inlineCheckbox1" value="1" name="Add_new_product"
                                    ...
                                    <div class="form-check form-check-inline mx-4  ">
                                        <input class="mx-2 form-check-input" type="checkbox"
                                            {{ data_get($product_approval_datas, 'Update_product_price', null) == 1 ? 'checked' : '' }}
                                            id="inlineCheckbox2" value="1" name="Update_product_price"
                                            {{ $product_approval == 1 ? ' ' : 'disabled' }}>
                                        <label class=" form-check-label"
                                    ...
                                    <div class="form-check form-check-inline mx-4  ">
                                        <input class="mx-2 form-check-input" type="checkbox"
                                            {{ data_get($product_approval_datas, 'Update_product_variation', null) == 1 ? 'checked' : '' }}
                                            id="inlineCheckbox3" value="1" name="Update_product_variation"
                                            {{ $product_approval == 1 ? ' ' : 'disabled' }}>
                                        <label class=" form-check-label"
                                    ...
                                    <div class="form-check form-check-inline mx-4  ">
                                        <input class="mx-2 form-check-input" type="checkbox"
                                            {{ data_get($product_approval_datas, 'Update_anything_in_product_details', null) == 1 ? 'checked' : '' }}
                                            id="inlineCheckbox4" value="1" name="Update_anything_in_product_details"
                                            {{ $product_approval == 1 ? ' ' : 'disabled' }}>
                                        <label class=" form-check-label"
