    ...
    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['user','registration']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['user','offline-payment-deny']) }}">
