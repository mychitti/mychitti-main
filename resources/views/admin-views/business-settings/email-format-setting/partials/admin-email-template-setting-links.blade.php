    ...
    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['admin','store-registration']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['admin','dm-registration']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['admin','withdraw-request']) }}">
                    {{translate('Withdraw Request')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/admin/campaign-request') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.get', ['admin','campaign-request']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['admin','refund-request']) }}">
                    {{translate('Refund Request')}}
                </a>
            </li>
            {{-- <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/admin/login') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.get', ['admin','login']) }}">
