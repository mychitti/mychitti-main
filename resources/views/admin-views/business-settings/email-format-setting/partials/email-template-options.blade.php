<div>
    <select id="mail-route-selector" class="custom-select w-auto min-width-170px">
        <option value="admin" {{ Request::is('admin/business-settings/email-setup/admin*') ? 'selected' : '' }}><a href="https://mychitti.net/">{{ translate('Admin_Mail_Templates') }}</a></option>
        <option value="store" {{ Request::is('admin/business-settings/email-setup/store*') ? 'selected' : '' }}><a href="https://mychitti.net/">{{ translate('Store_Mail_Templates') }}</a></option>
