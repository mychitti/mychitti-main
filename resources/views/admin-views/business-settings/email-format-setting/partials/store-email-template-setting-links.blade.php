<div class="d-flex flex-wrap justify-content-between align-items-center mb-5 mt-4 __gap-12px">
    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/store/status-update') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.get', ['store','status-update']) }}">
                  Order Status Update
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/store/registration') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.get', ['store','registration']) }}">
                    {{translate('New Store Registration')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/store/approve') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.get', ['store','approve']) }}">
                    {{translate('New_Store_Approval')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/store/deny') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.get', ['store','deny']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['store','withdraw-approve']) }}">
                    {{translate('Withdraw_Approval')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/store/withdraw-deny') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.get', ['store','withdraw-deny']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['store','campaign-request']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['store','campaign-approve']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['store','campaign-deny']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.get', ['store','product-approved']) }}">
                    {{translate('Product_approved')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/store/product-deny') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.get', ['store','product-deny']) }}">
