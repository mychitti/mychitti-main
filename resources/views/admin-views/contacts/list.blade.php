...
@section('title', translate('messages.Messages'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{ translate('messages.all_requirements_lists') }}
            </h2>
        </div>
        <!-- End Page Title -->
        <!-- End Page Header -->
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">
                                {{ translate('messages.requirements_lists') }} <span class="badge badge-soft-dark ml-2"
                                    id="itemCount">{{ count($requirements) }}</span>
                            </h5>
                        </div>
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                <tr class="text-center">
                                    ...
                                    <th class="border-0">{{ translate('messages.requirement_type') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn action-btn btn--danger btn-outline-danger form-alert"
                                                href="javascript:" data-id="requirement-{{ $req['id'] }}"
                                                data-message="{{ translate('messages.Want to delete this requirement?') }}"
                                                title="{{ translate('messages.delete') }}"><i
                                                    class="tio-delete-outlined"></i>
                                            </a>
                                            <form action="{{ route('admin.requirement.delete', [$req['id']]) }}"
                                                method="get" id="requirement-{{ $req['id'] }}">
                                                @csrf
                                            </form>
                                        </td>
                                    </tr>
                            ...
                            <form class="search-form">
                                <div class="input-group input--group">
                                    <input type="search" name="search" class="form-control"
                                        placeholder="{{ translate('ex_: search_by_name,_email,_or_subject') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                <a class="btn action-btn btn--danger btn-outline-danger form-alert"
                                                    href="javascript:" data-id="contact-{{ $contact['id'] }}"
                                                    data-message="{{ translate('messages.Want to delete this message?') }}"
                                                    title="{{ translate('messages.delete') }}"><i
                                                        class="tio-delete-outlined"></i>
                                                </a>
                                                <form
