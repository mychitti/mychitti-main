                                ...
                                <tbody>
                                    ...
                                    @if ($contact->file)
                                        <tr>
                                            ...
                                            <td>{{ translate('messages.File') }}:</td>
                                            @php
                                                $filePath = asset('storage/app/public/contact/' . $contact->file);
                                                $extension = strtolower(pathinfo($contact->file, PATHINFO_EXTENSION));
                                                $imageExtensions = ['jpg', 'jpeg', 'png', 'gif', 'webp', 'bmp'];
                                            @endphp

                                            <td>
                                                @if (in_array($extension, $imageExtensions))
                                                    <a style="cursor: zoom-in;" href="{{ $filePath }}" download>
                                                        <img style="width: 100px" src="{{ $filePath }}" alt="file">
                                                    </a>
                                                @else
