                        ...
                        <form action="{{ route('admin.coupon.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-3 col-sm-6" id="customer_wise">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="select_customer">{{ translate('messages.select_customer') }} (optional)</label>
                                ...
                                <div class="col-md-4 col-lg-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.001" min="1" max="999999999999.99"
                                ...
                                <div class="col-md-4 col-lg-3 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            ...
                                            ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label>
                                        <input type="number" step="0.001" name="min_purchase" value="0"
