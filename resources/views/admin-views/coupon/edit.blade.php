            ...
            <div class="card-body">
                <form action="{{ route('admin.coupon.update', [$coupon['id']]) }}" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="form-group col-md-4 col-lg-3 col-sm-6" id="customer_wise"
                            ...
                            <select name="customer_ids[]" id="select_customer" class="form-control js-select2-custom"
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="number" id="discount" min="1" max="999999999999.99"
                                    step="0.001" value="{{ $coupon['discount'] }}" name="discount"
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="number" min="0" max="999999999999.99" step="0.001"
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label"
                                    ...
                                    ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label>
                                <input type="number" name="min_purchase" step="0.001"
