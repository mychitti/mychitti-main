                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="number" id="discount" min="1" max="999999999999.99" step="0.001" value="{{$coupon['discount']}}"
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="number" min="0" max="999999999999.99" step="0.001" value="{{$coupon['max_discount']}}" name="max_discount" id="max_discount" class="form-control" {{$coupon['discount_type']=='amount'?'readonly="readonly"':''}}>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="number" name="min_purchase" step="0.001" value="{{$coupon['min_purchase']}}"
