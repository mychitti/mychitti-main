...
@section('title',translate('Service Bulk Import'))
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.services')}} {{translate('messages.bulk_import')}}
                </span>
            </h1>
        </div>
        <!-- Content Row -->
        ...
        <form class="product-form" id="import_form" action="{{route('admin.item.bulk-import')}}" method="POST"
            ...
            <div class="card mt-2 rest-part">
                <div class="card-body">
                    <h4 class="mb-3">{{translate('messages.import_service_file')}}</h4>
