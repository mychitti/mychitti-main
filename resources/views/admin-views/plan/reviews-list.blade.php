    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.service')}} {{translate('messages.reviews')}} <span class="badge badge-soft-dark ml-2" id="itemCount">{{$reviews->total()}}</span>
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
                ...
                <div class="search--button-wrapper justify-content-end">
                    <form id="search-form" class="search-form">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch" name="search" type="search" class="form-control min-height-45" placeholder="{{translate('ex_:_search_service_name')}}" aria-label="{{translate('messages.search_here')}}">
            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tr>
                        ...
                        <th class="border-0 w--1">{{translate('messages.service')}}</th>
                    ...
                    @foreach($reviews as $key=>$review)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                <p class="text-danger">{{translate('messages.Service deleted!')}}</p>
                                @endif
