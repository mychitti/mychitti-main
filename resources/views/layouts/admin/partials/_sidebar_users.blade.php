    ...
    <aside
        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg-white" id="navbar-vertical-content">
                ...
                <li
                    class="navbar-vertical-aside-has-menu {{ Request::is('users/delivery-man/vehicle*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('users/delivery-man/add') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('users/delivery-man/new') || Request::is('users/delivery-man/deny')  ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('users/delivery-man') ||  Request::is('users/delivery-man/edit*') ||  Request::is('users/delivery-man/preview*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('users/delivery-man/reviews') ? 'active' : '' }}">
