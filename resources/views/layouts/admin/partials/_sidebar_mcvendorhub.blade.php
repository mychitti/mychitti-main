        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg-white" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <!-- MC Vendorhub Section -->
                    <li class="nav-item">
                        <small class="nav-subtitle" title="{{ translate('MC Vendorhub') }}">{{ translate('MC Vendorhub') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>

                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/mcvendorhub') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.mcvendorhub.dashboard') }}" title="{{ translate('Dashboard') }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/mcvendorhub/vendors*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.mcvendorhub.vendors') }}" title="{{ translate('Vendors') }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/mcvendorhub/subscriptions*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.mcvendorhub.subscriptions') }}" title="{{ translate('Subscriptions') }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/mcvendorhub/enquiries*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.mcvendorhub.enquiries') }}" title="{{ translate('Enquiries') }}">
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle" title="{{ translate('MyChitti') }}">{{ translate('MyChitti') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>

                    <li class="navbar-vertical-aside-has-menu">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.dashboard') }}" title="{{ translate('Back to MyChitti') }}">
                            <i class="tio-back-ui nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{ translate('Back to MyChitti') }}
                            </span>
                        </a>
                    </li>
                    <!-- End MC Vendorhub Section -->
