    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg-white" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ (Request::is('business-settings/zone*') && !Request::is('business-settings/zone/area-request'))? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/zone/area-request') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.business-settings.zone.requests') }}" title="Area Requests">
                        <i class="tio-city nav-icon"></i> 
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                           City Requests</span>
                    </a>
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/module') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('business-settings/module*') ? 'block' : 'none' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/business-setup*') || Request::is('business-settings/language*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/file-manager*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/third-party*') || Request::is('business-settings/fcm*') || Request::is('business-settings/login-url-setup*') || Request::is('business-settings/offline-payment*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('business-settings/third-party*')|| Request::is('business-settings/fcm*') ||Request::is('business-settings/login-url-setup*') || Request::is('business-settings/offline-payment*') ? 'block' : 'none' }}">
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/third-party*') ? 'active' : '' }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/fcm*') ? 'active' : '' }}">
                        ...
                        @php($waActive = Request::is('business-settings/third-party/whatsapp-config*') || Request::is('business-settings/third-party/whatsapp-templates*') || Request::is('business-settings/third-party/whatsapp-bulk*') || Request::is('business-settings/third-party/whatsapp-inbox*') || Request::is('business-settings/third-party/whatsapp-knowledge*') || Request::is('business-settings/third-party/whatsapp-report*') || Request::is('business-settings/third-party/whatsapp-lead-notifications*') || Request::is('business-settings/third-party/whatsapp-vendor-billing*') || Request::is('business-settings/third-party/wa-chat*') || Request::is('business-settings/third-party/wa-chats*'))
                        <li class="navbar-vertical-aside-has-menu {{ $waActive ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ $waActive ? 'block' : 'none' }}">
                                ...
                                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/third-party/whatsapp-bulk*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.business-settings.third-party.whatsapp-bulk') }}" title="{{ translate('WhatsApp Bulk Message') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('WhatsApp Bulk Message') }}</span>
                                    </a>
                                </li>
                                ...
                                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/third-party/wa-chat-feed*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.business-settings.third-party.wa-chat-feed') }}" title="{{ translate('WhatsApp Intelligence') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('WhatsApp Intelligence') }}</span>
                                    </a>
                                </li>
                                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/third-party/wa-chats*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.business-settings.third-party.wa-chats') }}" title="{{ translate('WhatsApp Chats') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('Archived Chats') }}</span>
                                    </a>
                                </li>
                                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/third-party/wa-chat-messages*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.business-settings.third-party.wa-chat-messages') }}" title="{{ translate('WhatsApp Archive') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('Message Archive') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        @if (\App\CentralLogics\Helpers::get_mail_status('offline_payment_status'))
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/offline*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/email-setup*') ? 'active' : '' }}">
                    <a class="nav-link " href="{{ route('admin.business-settings.email-setup.get',['admin','forgot-password']) }}" title="{{ translate('messages.email_template') }}">
                ...
                @if(config('addon_admin_routes') && count(config('addon_admin_routes'))>0)
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('payment/configuration/*') || Request::is('sms/configuration/*')?'active':''}}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('payment/configuration/*') || Request::is('sms/configuration/*')?'block':'none'}}">
