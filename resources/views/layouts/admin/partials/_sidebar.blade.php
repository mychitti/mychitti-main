        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg-white" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('zone*') ? 'active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('module') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('module*') ? 'block' : 'none' }}">
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('module/create') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('banner*') ? 'block' : 'none' }}">
                        ...
                        <li class="nav-item {{ Request::is('banner/vendor-approvals') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.banner.vendor-approvals') }}" title="Vendor Banner Approvals">
                                ...
                                @php($pendingVendorBanners = \App\Models\Banner::where('created_by','store')->where('approval',0)->count())
                ...
                <!-- End marketing section -->
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li class="nav-item {{ Request::is('refund/requested') ||  Request::is('refund/rejected') ||Request::is('refund/refunded') ? 'active' : '' }}">
                         ...
                         {{-- <li class="nav-item {{ Request::is('refund/settings') ? 'active' : '' }}">
                    ...
                    <!-- Order dispachment -->
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('dispatch/*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="{{ Request::is('dispatch*') ? 'display-block' : 'display-none' }}">
                            <li class="nav-item {{ Request::is('dispatch/list/searching_for_deliverymen') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('dispatch/list/on_going') ? 'active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('parcel*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('parcel*') ? 'block' : 'none' }}">
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('parcel/category') ? 'active' : '' }}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('parcel/orders*') ? 'active' : '' }}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('parcel/settings') ? 'active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('category*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('category*') ? 'block' : 'none' }}">
                            <li class="nav-item @yield('main_category') {{ Request::is('category/add') ? 'active' : '' }}">
                            ...
                            <li class="nav-item @yield('sub_category') {{ Request::is('category/add-sub-category') ? 'active' : '' }}">
                            ...
                            {{-- <li class="nav-item {{Request::is('category/add-sub-sub-category')?'active':''}}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('addon*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('addon*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('addon/add-new') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('addon/bulk-import') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.addon.bulk-import') }}" title="{{ translate('messages.bulk_import') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate text-capitalize">{{ translate('messages.bulk_import') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('addon/bulk-export') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('item*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('item*') ? 'block' : 'none' }}">
                        ...
                        <li class="nav-item {{ Request::is('item/new/item/list') || (Request::is('item/edit/*') && strpos(request()->fullUrl(), 'temp_product=1') !== false  ) ? 'active' : '' }}">
                ...
                <!-- End Food -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('store*') && !Request::is('store/withdraw_list') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('store*') ? 'block' : 'none' }}">
                            ...
                            <li class="navbar-item {{ Request::is('store/list') ||  Request::is('store/view/*')  ? 'active' : '' }}">
                            ...
                            <li class="navbar-item {{ Request::is('store/pending-requests') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('store/bulk-import') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.store.bulk-import') }}" title="{{ translate('messages.bulk_import') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate text-capitalize">{{ translate('messages.bulk_import') }}</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::is('store/bulk-export') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('delivery-man/new') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('delivery-man/reviews/list') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ (Request::is('customer/list') || Request::is('customer/view*')) ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('customer/wallet*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('customer/wallet*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('customer/wallet/add-fund') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('customer/wallet/report*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('customer/loyalty-point*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('customer/loyalty-point*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('customer/loyalty-point/report*') ? 'active' : '' }}">
                ...
                <!-- End Custommer -->
                <li class="navbar-vertical-aside-has-menu {{ Request::is('customer/subscribed') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('customer/settings') ? 'active' : '' }}">
                ...
                <li
                class="navbar-vertical-aside-has-menu {{ Request::is('message/list') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('store/withdraw*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('account-transaction*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('provide-deliveryman-earnings*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/business-setup') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{Request::is('business-settings/social-media')?'active':''}}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/payment-method') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/mail-config') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/sms-module') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/fcm-index') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/app-settings*') ? 'active' : '' }}">
                    <a class="nav-link " href="{{ route('admin.business-settings.app-settings.get') }}" title="{{ translate('messages.app_settings') }}">
                        <span class="tio-android nav-icon"></span>
                        <span class="text-truncate">{{ translate('messages.app_settings') }}</span>
                    </a>
                </li>
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/landing-page-settings*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/config*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/pages*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('business-settings/pages*') ? 'block' : 'none' }}">

                        <li class="nav-item {{ Request::is('business-settings/pages/terms-and-conditions') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('business-settings/pages/privacy-policy') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('business-settings/pages/about-us') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('business-settings/pages/refund') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('business-settings/pages/cancelation') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('business-settings/pages/shipping-policy') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('file-manager*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{Request::is('social-login/view')?'active':''}}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('business-settings/recaptcha*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{Request::is('business-settings/db-index')?'active':''}}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('report/item-wise-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('report/stock-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('report/store-wise-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('report/order-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('report/transaction-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('report/expense-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('custom-role*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('employee*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('employee*') ? 'block' : 'none' }}">
                        ...
                        <li class="nav-item {{ Request::is('employee/list') ? 'active' : '' }}">
