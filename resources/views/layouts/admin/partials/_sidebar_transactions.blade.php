    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg-white" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/store/withdraw*') ? 'active' : '' }}">
                ...
                <!-- End withdraw -->
                    @if ( \App\CentralLogics\Helpers::module_permission_check('account'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('transactions/store-disbursement*') ? 'active' : '' }}">
                    ...
                    @if ( \App\CentralLogics\Helpers::module_permission_check('account'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('transactions/dm-disbursement*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/account-transaction*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/provide-deliveryman-earnings*') ? 'active' : '' }}">
                ...
                @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                    <li
                        class="navbar-vertical-aside-has-menu {{ Request::is('transactions/withdraw-method*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/report/day-wise-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/report/item-wise-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/report/store*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/report/expense-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/report/disbursement-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/report/low-stock-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('transactions/report/order-report') ? 'active' : '' }}">
