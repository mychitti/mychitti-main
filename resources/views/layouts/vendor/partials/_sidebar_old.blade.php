            ...
            <div class="navbar-vertical-content text-capitalize bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (selected_menu('notifications'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/notifications*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @if (selected_menu('task_management') && hasAnyPermission(['task.list', 'task.export', 'task.add', 'task.settings']))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/task*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('store-panel/task/add') ? 'block' : 'none' }}">
                    ...
                    @endif
                    @if (selected_menu('company_asset'))
                        @if (auth('vendor')->check())
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/asset*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('vendor.asset.index') }}" title="Assets">
                                    <img src="{{ asset('storage/app/public/nav/fixed-asset.png') }}" alt="assets"
                                        class="nav-link-icon">
                                    <span class=" text-truncate">Company Assets (properties)</span>
                                </a>
                            </li>
                        @else
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('vendor.asset.alotted') }}" title="Assets">
                                    <img src="{{ asset('storage/app/public/nav/fixed-asset.png') }}"
                                        alt="assets alotted" class="nav-link-icon">
                                    <span class=" text-truncate">Company Assets (properties)</span>
                                </a>
                            </li>
                        @endif
                    ...
                    @if (selected_menu('patients_manage') && _offeredModule('patient_manage'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/customer*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('vendor.patient.add') }}" title="notifications">
                    ...
                    @if (selected_menu('leads_manage') && auth('vendor')->check() && $store_data->module->id == 6)
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/item/service-requests*') || Request::is('store-panel/lead*') || Request::is('store-panel/service/leads*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/item/service-requests*') || Request::is('store-panel/service/leads*') ? 'active' : '' }}">
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        style="display: {{ Request::is('store-panel/item/service-requests*') || Request::is('store-panel/service/leads*') ? 'block' : 'none' }}">
                                        ...
                                        @if ($store_data->module->id == 6)
                                            {{-- <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/business-settings/generate-bill') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('vendor.business-settings.generate-bill.list') }}"
                                            title="{{ translate('messages.Service Bill') }}">
                                            <span class="tio-documents nav-icon"></span>
                                            <span class="text-truncate">Generate Service Bill</span>
                                        </a>
                                    </li> --}}
                                        @endif

                                        <li class="nav-item {{ Request::is('store-panel/service/report') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('vendor.service.report') }}"
                                                title="report">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate sidebar--badge-container">
                                                    Leads Report
                                ...
                                @if (\App\CentralLogics\Helpers::permission_check('advanced_leads_manage'))
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/lead*') ? 'active' : '' }}">
                                        <a class="sub-link  js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            href="javascript:;" title="My Leads">
                                            <i class="tio-message-play nav-icon"></i>
                                            <span
                                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">My
                                                Leads
                                            </span>
                                        </a>

                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            style="display: {{ Request::is('store-panel/lead*') ? 'block' : 'none' }}">
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/lead*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('vendor.module-offer', ['leads']) }}" title="leads">
                                            <i class="tio-shopping-cart nav-icon"></i>
                                            <span
                    ...
                    <!-- Business Section-->
                    @if (selected_menu('business_section'))
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                ...
                                @if (\App\CentralLogics\Helpers::employee_module_permission_check('store_setup'))
                                    ...
                                    <li class="nav-item {{ Request::is('store-panel/business-settings/about-us') ? 'active' : '' }}"
                                        style="margin-top:0 !important;">
                                        <a class="nav-link " href="{{ route('vendor.business-settings.about-us') }}"
                                    ...
                                    <li class="nav-item {{ Request::is('store-panel/general/holidays') ? 'active' : '' }}"
                                        style="margin-top:0 !important;">
                                        <a class="nav-link " href="{{ route('vendor.settings.general.holidays') }}"
                                            title="Holidays">
                                            <span class="tio-circle nav-indicator-icon"></span>
                    ...
                    @endif
                    @if (selected_menu('settings') && \App\CentralLogics\Helpers::employee_module_permission_check('store_setup'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/business-settings/settings*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;"
                                title="Settings">
                                <img src="{{ asset('storage/app/public/nav/adjustment.png') }}" alt=""
                                    class="nav-link-icon">
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    Settings</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                {{-- <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/settings/general-settings*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                        href="javascript:;" title="Leads">
                                        <i class="tio-settings nav-icon"></i>
                                        <span class=" text-truncate">General
                                            Settings</span>
                                    </a>

                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        style="display: {{ Request::is('store-panel/settings/general-settings/profile*') || Request::is('store-panel/business-settings/store-setup') ? 'block' : 'none' }}">

                                       
                                    </ul>
                                </li> --}}
                                <li class="nav-item {{ Request::is('store-panel/business-settings/settings/invoice-settings') ? 'active' : '' }}"
                                    style="margin-top:0 !important;">
                                    <a class="nav-link "
                                        href="{{ route('vendor.business-settings.settings.invoice') }}"
                                        title="Invoice Settings">
                                        <span class="tio-settings nav-icon"></span>
                                        <span class="text-truncate">Invoice Settings</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('store-panel/business-settings/settings/quotation-settings') ? 'active' : '' }}"
                                    style="margin-top:0 !important;">
                                    <a class="nav-link "
                                        href="{{ route('vendor.business-settings.settings.quotation') }}"
                    ...
                    @if (selected_menu('account_manage') && \App\CentralLogics\Helpers::employee_module_permission_check('account_manage'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                ...
                                @if (\App\CentralLogics\Helpers::permission_check('account_manage'))
                                    @if (_storeAccountType() == 'ledger')
                                        <li
                                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/approvals') ? 'active' : '' }}">
                                        ...
                                        <li
                                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account') ? 'active' : '' }}">
                                            <a class="sub-link js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/request-form/journal-entry') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                ...
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/request-form/master-ledger') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                ...
                                                @if (auth('vendor_employee')->check())
                                                    <li
                                                        class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/management') ? 'active' : '' }}">
                                                        <a class="nav-link "
                                    ...
                                    <li
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                            ...
                                            <li
                                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/journal-entry') ? 'active' : '' }}">
                                                <a class="nav-link "
                                            ...
                                            @if (_storeAccountType() == 'ledger')
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/day-book') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                ...
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/petty-cashbook') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                ...
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/maintenance') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.account.maintenance.index') }}"
                                                        title="{{ translate('messages.monthly_maintenance') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Monthly Maintenance</span>
                                                    </a>
                                                </li>
                                            @endif
                                        </ul>
                                    ...
                                    @if (_storeAccountType() == 'ledger')
                                        <li
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/back-accounts') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.account.banking.bank-account.index') }}"
                                                        title="{{ translate('messages.bank_accounts') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Bank Accounts</span>
                                                    </a>
                                                </li>
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/cash-book') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                ...
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/bank-reconciliation') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.account.banking.bank-reconciliation.index') }}"
                                                        title="{{ translate('messages.bank_reconciliation') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Bank Reconciliation</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/trial-balance') ? 'active' : '' }}">
                                                    <a class="nav-link " href="{{route('vendor.account.statement.trial-balance')}}"
                                                        title="{{ translate('messages.trial_balance') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Trial Balance</span>
                                                    </a>
                                                </li>
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/balance-sheet') ? 'active' : '' }}">
                                                    <a class="nav-link " href="javascript:;"
                                                        title="{{ translate('messages.balance_sheet') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Balance Sheet</span>
                                                    </a>
                                                </li>
                                        ...
                                        <li
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                ...
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/tax-report') ? 'active' : '' }}">
                                                    <a class="nav-link " href="javascript:;"
                                                        title="{{ translate('messages.Bill Payments') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Bill Payments
                                                        </span>
                                                    </a>
                                                </li>
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/recurring-monthly-finance') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.account.monthly-finance.property-valuation') }}"
                                                        title="{{ translate('messages. Property Valuation ') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Property Valuation</span>
                                                    </a>
                                                </li>
                                        ...
                                        <li
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                ...
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/report/taxau') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.account.report.tax') }}"
                                                        title="{{ translate('messages. Tax Reports (GST/VAT) ') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Tax Reports (GST/VAT)</span>
                                                    </a>
                                                </li>
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/audit-logs') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.account.report.audit-logs') }}"
                                                        title="{{ translate('messages. Audit Logs ') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Audit Logs</span>
                                                    </a>
                                                </li>
                                        ...
                                        <li
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                ...
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/tax') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.account.taxation.gst') }}"
                                                        title="{{ translate('messages.GST') }}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">GST</span>
                                                    </a>
                                                </li>
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/tax') ? 'active' : '' }}">
                                                    <a class="nav-link " href="javascript:;"
                                                        ...
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">TDS</span>
                                                    </a>
                                                </li>
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/tax') ? 'active' : '' }}">
                                                    <a class="nav-link " href="javascript:;"
                                                        ...
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">TCS</span>
                                                    </a>
                                                </li>
                                                <li
                                                    class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/tax') ? 'active' : '' }}">
                                                    <a class="nav-link " href="javascript:;"
                                                        ...
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-account-square">Other Taxes</span>
                                                    </a>
                                                </li>
                                    ...
                                    <li
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                            ...
                                            {{-- <li
                                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/settings') ? 'active' : '' }}">
                                                <a class="nav-link " href="javascript:;"
                                                    title="{{ translate('messages.Financial Year Setup') }}">
                                                    <span class="tio-circle nav-indicator-icon"></span>
                                                    <span class="text-account-square">Financial Year Setup</span>
                                                </a>
                                            </li>
                                            <li
                                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/settings') ? 'active' : '' }}">
                                                <a class="nav-link " href="javascript:;"
                                                    title="{{ translate('messages. Account Groups ') }}">
                                                    <span class="tio-circle nav-indicator-icon"></span>
                                                    <span class="text-account-square">Account Groups</span>
                                                </a>
                                            </li> --}}
                                            <li
                                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/settings') ? 'active' : '' }}">
                                                <a class="nav-link " href="{{ route('vendor.account.setting') }}"
                                                    ...
                                                    <span class="tio-circle nav-indicator-icon"></span>
                                                    <span class="text-account-square">Account Type</span>
                                                </a>
                                            </li>
                                            <li
                                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/account/settings') ? 'active' : '' }}">
                                                <a class="nav-link "
                                                    ...
                                                    <span class="tio-circle nav-indicator-icon"></span>
                                                    <span class="text-account-square">Common Settings</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                ...
                                <li
                                    ...
                                    <a class="nav-link " href="{{ route('vendor.business-settings.manual-bill') }}"
                                        title="{{ translate('messages.New Manual Bills') }}">
                                        <span class="tio-document-text nav-icon"></span>
                                        <span class="text-truncate">Generate Bill (Basic)</span>
                                    </a>
                                </li>
                                <li
                                    ...
                                    <a class="nav-link " href="{{ route('vendor.invoice.create-invoice') }}"
                                        title="{{ translate('messages.Manual Bills') }}">
                                        <span class="tio-document-text nav-icon"></span>
                                        <span class="text-truncate">Generate Bill (Advanced)</span>
                                    </a>
                                </li>
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                @if (hasPermission('inventory', 'dashboard'))
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/inventory/dashboard') ? 'active' : '' }}">
                                ...
                                <li
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        style="display: {{ Request::is('store-panel/inventory') ? 'block' : 'none' }}">
                                        ...
                                        {{-- <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/inventory/category') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('vendor.inventory.category.index') }}"
                                            title="{{ translate('messages.category') }}">
                                    ...
                                    <li
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            ...
                                            @if (hasPermission('inventory_purchase_order', 'add') || hasPermission('inventory_purchase_order', 'list'))
                                                <li
                                                    class="nav-item {{ Request::is('store-panel/inventory/purchase/order') ? 'active' : '' }}">
                                                    <a class="nav-link"
                                            ...
                                            @if (hasPermission('inventory_purchase_return', 'add') || hasPermission('inventory_purchase_return', 'list'))
                                                <li
                                                    class="nav-item {{ Request::is('store-panel/inventory/purchase/order') ? '' : '' }}">
                                                    <a class="nav-link"
                    ...
                    @if (
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/staff*') || Request::is('store-panel/salary*') || Request::is('store-panel/leave*') || Request::is('store-panel/attendance*') ? 'active' : '' }} ">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                href="javascript:;" title="HR Management">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                ...
                                @if (selected_menu('staff_manage') && \App\CentralLogics\Helpers::employee_module_permission_check('hr_manage'))
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/staff*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            href="javascript:;" title="Leads">
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            style="display: {{ Request::is('store-panel/staff*') ? 'block' : 'none' }}">
                                            ...
                                            <li class="nav-item {{ Request::is('store-panel/staff-role*') ? 'active' : '' }}">
                                                <a class="nav-link "
                                ...
                                @if (selected_menu('attendance_manage') && \App\CentralLogics\Helpers::employee_module_permission_check('hr_manage'))
                                    @if (\App\CentralLogics\Helpers::permission_check('hr_manage'))
                                        <li
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                                ...
                                                <li
                                                    ...
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.attendance.all') }}"
                                        ...
                                        {{-- @elseif(auth('vendor')->check())
                                        <li
                                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/module/attendance*') ? 'active' : '' }}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                                href="{{ route('vendor.module-offer', ['attendance']) }}"
                                                title="Attendance Management">
                                                <i class="tio-category nav-icon"></i>
                                                <span
                                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Attendance
                                                    Management</span>
                                            </a>
                                        </li> --}}
                                    @endif
                                ...
                                @if (\App\CentralLogics\Helpers::employee_module_permission_check('hr_manage'))
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/shifts*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                @if (selected_menu('leave_manage') && \App\CentralLogics\Helpers::employee_module_permission_check('hr_manage'))
                                    @if (\App\CentralLogics\Helpers::permission_check('hr_manage'))
                                        <li
                                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/leave*') ? 'active' : '' }}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                                href="{{ route('vendor.leave.all') }}" title="Leave Management">
                                                <i class="tio-category nav-icon"></i>
                                                <span class="text-truncate">Leave
                                                    Management</span>
                                            </a>
                                        </li>
                                        {{-- @elseif(auth('vendor')->check())
                                        <li
                                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/module/leave-management*') ? 'active' : '' }}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                                href="{{ route('vendor.module-offer', ['leave']) }}"
                                ...
                                @if (selected_menu('salary_manage') && \App\CentralLogics\Helpers::employee_module_permission_check('hr_manage'))
                                    @if (\App\CentralLogics\Helpers::permission_check('hr_manage'))
                                        <li
                                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/salary*') ? 'active' : '' }}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                                style="display: {{ Request::is('store-panel/salary*') ? 'block' : 'none' }}">
                                                ...
                                                <li
                                                    class="nav-item {{ Request::is('store-panel/salary/task-salary-categories') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                ...
                                                <li
                                                    ...
                                                    <a class="nav-link "
                                                        href="{{ route('vendor.salary.report') }}" title="report">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                        ...
                                        {{-- @elseif(auth('vendor')->check())
                                        <li
                                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/module/salary*') ? 'active' : '' }}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                                href="{{ route('vendor.module-offer', ['salary']) }}"
                                                title="Salary Management">
                                                <i class="tio-category nav-icon"></i>
                                                <span
                                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Salary
                                                    Management</span>
                                            </a>
                                        </li> --}}
                                    @endif
                    ...
                    @if (selected_menu('quotation_manage') &&
                        ...
                        @if (\App\CentralLogics\Helpers::permission_check('quotaiton_manage'))
                            ...
                            {{-- @elseif(auth('vendor')->check())
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/module/quotation-management*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('vendor.module-offer', ['quotation']) }}"
                    ...
                    @if (selected_menu('project_manage') && \App\CentralLogics\Helpers::employee_module_permission_check('project_manage'))
                        @if (\App\CentralLogics\Helpers::permission_check('projects_manage'))
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/project*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:;" title="Project Management">
                                    <i class="tio-money nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Project
                                        Management</span>
                                </a>

                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('store-panel/project/add') ? 'block' : 'none' }}">
                            ...
                            {{-- @elseif(auth('vendor')->check())
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/module/project-management*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('vendor.module-offer', ['project']) }}"
                    ...
                    @if (auth('vendor')->check())
                        @if (selected_menu('offer_banner'))
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    ...
                                    <img src="{{ asset('storage/app/public/nav/sale.png') }}" alt=""
                                        class="nav-link-icon">
                        ...
                        @if (selected_menu('gallery'))
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/gallery') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('vendor.gallery.all') }}"
                                    title="{{ translate('messages.gallery') }}">
                                    <img src="{{ asset('storage/app/public/nav/gallery.png') }}" alt=""
                                        class="nav-link-icon">
                        ...
                        @if (selected_menu('documents'))
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/documents*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('store-panel/receivable-receipt/list*') ? 'block' : 'none' }}">

                                    <li
                                        class="nav-item {{ Request::is('store-panel/documents/receivable-receiptp/list') ? 'active' : '' }}">
                                        <a class="nav-link "
                        ...
                        @endif
                    @endif
                    @if (selected_menu('reviews') && \App\CentralLogics\Helpers::employee_module_permission_check('reviews'))
                        <li
                    ...
                    @if (auth('vendor')->check())
                        <li
                            ...
                            <a class="nav-link " href="{{ route('vendor.terms-and-conditions.view') }}"
                                title="My Chitti T&C">
                    ...
                    @elseif(auth('vendor_employee')->check())
                        <li
                            ...
                            <a class="nav-link " href="{{ route('vendor.staff.terms-n-conditions') }}"
                    ...
                    @endif
                    {{-- <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/sub-module/list') ? 'active' : '' }}">
                        <a class="nav-link " href="{{ route('vendor.sub-module.list') }}"
                            title="Products Pricing">
                            <span class="tio-shopping-icon  nav-icon"></span>
                            <span class="text-truncate">Products Pricing</span>
                        </a> 
                    </li> --}}
                    @if (selected_menu('subscriptions') && auth('vendor')->check())
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/sub-module/list') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('vendor.subscriptions') }}"
                                title="Subscriptions">
                    ...
                    <li
                        ...
                        <a class="nav-link " href="{{ route('vendor.menu_preference') }}"
                            title="Subscriptions">
