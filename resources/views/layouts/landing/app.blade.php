            ...
            <div class="container">
                <div class="navbar-bottom-wrapper">
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            <a href="{{route('user-terms-and-conditions')}}" class="{{ Request::is('terms-and-conditions') ? 'active' : '' }}"><span>{{ translate('messages.terms_and_condition') }}</span></a>
                        </li>
                        <li>
                ...
                <div class="footer-wrapper ps-xl-5">
                    ...
                    <div class="footer-widget widget-links">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{route('user-terms-and-conditions')}}">{{ translate('messages.terms_and_condition') }}</a>
                            </li>
