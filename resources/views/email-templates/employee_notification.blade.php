        ...
        <tbody>
            <tr>
                <td class="main-table-td">
                    ...
                    <div class="mb-1" id="">{{ 'Dear '. $name .',' }}</div>
                    <div class="mb-1" id="mail-body">{!! $msg?? translate('Hi_Sabrina,') !!}</div>
                    @if ($url)
                    <span class="d-block text-center" style="margin-top: 16px">
                    <a href="{{ $url ??'#' }}" class="cmn-btn" id="mail-button">View</a>
                    </span>
                    @endif
            ...
            <tr>
                <td>
                    <span class="copyright" id="mail-copyright">
                        {{ $copyright_text ?? translate('Copyright 2024 My Chitti. All right reserved') }}
                    </span>
                </td>
            </tr>
        </tbody>
