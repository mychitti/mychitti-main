                        ...
                        <div id="login_with_otp_screen" style='display:none'>
                            ...
                            <form class="send_login_otp" action="{{ route('send-vendor-otp') }}" method="post"
                                ...
                                <div class="auth-header">
                                    <div class="mb-5">
                                        <h2 class="title">{{ translate($role) }} {{ translate('messages.signin') }}
                                        </h2>
                                ...
                                <button type="submit" id="send_otp_btn"
                                    class="btn btn-lg btn-block btn--primary mt-xxl-3">Send OTP</button>
                            </form>
                            <!--  -->
                            ...
                            <a class="text-center d-block" href="javascript:;" id="switch_login_with_pass">Login With
                                Password</a>
                        </div>
                    @endif
                    <form class="login_with_password_screen"
                        {{ isset($role) && $role == 'vendor' ? '' : '' }}
                        ...
                        <div class="js-form-message form-group">
                            ...
                            <input type="email" class="form-control form-control-lg" name="email"
                                ...
                                value="{{ $email ?? '' }}" aria-label="email@address.com" required
                        ...
                        @if (isset($role) && $role == 'vendor')
                            <p class="text-center my-2">OR</p>
                            <a class="text-center d-block" href="javascript:;" id="switch_login_with_otp">Login With
                                OTP</a>
                        @endif
                    </form>
                    <!-- End Form -->
                        ...
                        @if (isset($role) && $role == 'admin')
                            <div class="auto-fill-data-copy">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <button class="btn action-btn btn--primary m-0 copy_cred"><i
                                                class="tio-copy"></i>
                                        </button>
                                    </div>
                                </div>
                        ...
                        @if (isset($role) && $role == 'vendor')
                            <div class="auto-fill-data-copy">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <button class="btn action-btn btn--primary m-0 copy_cred2"><i
                                                class="tio-copy"></i>
                                        </button>
                                    </div>
                                </div>
