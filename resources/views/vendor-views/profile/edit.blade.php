        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9 row">
                                    <div class="col-md-6">
                                        <label for="name">First {{ translate('messages.Name') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="f_name" value="{{ $data->f_name }}"
                                            class="form-control" id="name" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="name">{{ translate('messages.Last_Name') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="js-masked-input form-control" name="phone"
                                ...
                                <div class="form-group col-md-9" id="select-img">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label"
                                            for="customFileUpload">{{ translate('messages.image_Upload') }}</label>
                                    </div>
                                </div>
                            </div>

                            <div class="d-flex justify-content-end">
                                <button type="button" data-id="seller-profile-form"
                                    data-message="{{ translate('Want to update seller info') }}"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" action="{{ route('vendor.profile.settings-password') }}"
                            ...
                            <div class="row form-group">
                                <label for="newPassword" class="col-sm-3 col-form-label input-label">
                                    {{ translate('messages.New_password') }}<span class="form-label-secondary"
                            ...
                            <div class="row form-group">
                                <label for="confirmNewPasswordLabel" class="col-sm-3 col-form-label input-label">
                                    {{ translate('messages.Confirm_password') }} </label>
