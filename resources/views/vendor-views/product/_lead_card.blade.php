                ...
                <div class="modal-body">
                    @if ($lead->assigned_status == 'Unassigned' || $lead->assigned_type == 'vendor')
                        @if ($lead->assigned_type == 'vendor')
                            <div
                                style="background:#f0fdf4;border-radius:8px;padding:10px 14px;font-size:13px;font-weight:600;color:#166534;margin-bottom:14px;">
                    ...
                    @else
                        ...
                        @if ($empInfo)
                            <div style="background:#fafafa;border-radius:10px;padding:14px;font-size:14px;">
                                ...
                                #{{ $lead->assigned_to }}
                                <span
                                    style="color:#71717a;">({{ !$lead->accepted_by_staff ? 'Acceptance Pending' : ($lead->accepted_by_staff == 2 ? 'Rejected' : 'Accepted') }})</span>
                            </div>
                        @endif
                    @endif
                </div>
