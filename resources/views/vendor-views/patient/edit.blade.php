...
@push('css_or_js')
    <style>.form-row { margin-top: 6px; }</style>
@endpush
...
<div class="content container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form method="POST" action="{{ route('vendor.patient.update', $patient->id) }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="blood_group" class="form-control">
                            ...
                            @foreach(['A+','A-','B+','B-','O+','O-','AB+','AB-'] as $bg)
                                <option {{ old('blood_group', $patient->blood_group) == $bg ? 'selected' : '' }}>{{ $bg }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-3">
                ...
                <div class="mt-3 d-flex justify-content-end w-100 gap-2">
                    <a href="{{ route('vendor.patient.show', $patient->id) }}" class="btn btn-soft-secondary ml-2">Cancel</a>
