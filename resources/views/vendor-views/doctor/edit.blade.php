            ...
            <div class="row">
                                ...
                                <div class=" col-md-6 form-group ">
                                    <div class="form-group mb-1">
                                        ...
                                        <select name="services[]" multiple="multiple"
                                            class=" form-control __form-control js-select2-custom js-example-basic-multiple"
                                            data-placeholder="Services">
                                            <option value=""></option>
                                            @foreach ($store_services as $service)
                                                <option {{ in_array($service->id, $doctor->services->pluck('item_id')->toArray()) ? 'selected' : '' }}
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('vendor.doctor.slots', $doctor->id) }}" class="btn btn-outline-info">Manage
                            Slots</a>
