        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="number" name="temperature" class="form-control form-control-sm"
                        placeholder="98.6" min="90" max="110" step="0.1"
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="number" name="spo2" class="form-control form-control-sm"
                        placeholder="98" min="0" max="100"
                        value="{{ old('spo2', $visit?->spo2) }}">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label class="input-label" style="font-size:12px;">Resp. Rate (/min)</label>
                    <input type="number" name="respiratory_rate" class="form-control form-control-sm"
                        placeholder="16" min="0" max="100"
                        value="{{ old('respiratory_rate', $visit?->respiratory_rate) }}">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
