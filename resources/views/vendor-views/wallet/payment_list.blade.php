                    ...
                    <tbody>
                        @foreach ($account_transaction as $k => $wr)
                            <tr>
                                ...
                                <td>
                                    @if ($wr['action'] == 'debit')
                                        <span class="text-danger"> -
                                            {{ \App\CentralLogics\Helpers::format_currency($wr['amount']) }}</span>
                                    @else
                                ...
                                <td>
                                    <span
                                        class="d-block">{{ \App\CentralLogics\Helpers::time_date_format($wr['created_at']) }}</span>
                                </td>
                                <td>
                                    @if ($wr->method)
                                        {{ translate($wr->method) }}
                                ...
                                <td>
                                    @if ($wr['action'] == 'debit')
                                        <label class="badge badge-soft-danger">Debited</label>
                                    @else
                                        <label class="badge badge-soft-success">Credited</label>
                                    @endif
                                </td>
...
@push('script_2')
    ...
    @if (request()->has('flag'))
        ...
        @endif
        <script>
            history.pushState({}, '', 'wallet-payment-list');
        </script>
    @endif
@endpush
