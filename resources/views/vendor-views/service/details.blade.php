                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <button type="button" class="btn btn-dark btn-sm add_more_btn"
                                                        onclick="addMoreRow()">Add More</button>
                                            </th>
                                        </tr>
                                    </thead>
                                ...
                                <tr class="item_row row_1" data-id="1">
                                    ...
                                    <td>
                                        <input type="file" name="image[0][]" multiple required
                                               class="form-control" accept="image/*,android/allowCamera">
                                    </td>
                                    <td>
...
@push('script_2')
    ...
    <script>
        ...
        document.addEventListener('change', function(e) {
            ...
            var total = files.length + existing;
            ...
            var imgSizeLimit  = {{ \App\Models\BusinessSetting::where('key', 'gatepass_image_max_size')->value('value') ?? 10 }};

            if (total > imgCountLimit) {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                if (files[i].size > imgSizeLimit * 1024 * 1024) {
                    errorBox.textContent = '"' + files[i].name + '" is larger than ' + imgSizeLimit + 'MB.';
                    input.value = ''; input.style.border = '2px solid red'; return;
                }
            }
        });
