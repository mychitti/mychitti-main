...
<div class="content container-fluid">
    <div class="page-header d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('vendor.hospital-bill.create-ipd', $admission->id) }}" class="btn btn-sm btn-outline-success">
                <i class="tio-receipt"></i> Generate Bill
            </a>
            @if($admission->status === 'admitted')
            <a href="{{ route('vendor.ipd.discharge-form', $admission->id) }}" class="btn btn-sm btn-outline-warning">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="card mb-3">
                <div class="card-header py-2"><h6 class="mb-0">Patient</h6></div>
                <div class="card-body">
            ...
            <div class="card mb-3">
                <div class="card-header py-2"><h6 class="mb-0">Bed &amp; Ward</h6></div>
                <div class="card-body">
                    <table class="table table-sm mb-0">
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ \App\Models\Ward::TYPES[$admission->ward?->ward_type] ?? $admission->ward?->ward_type }}</td>
                            </tr>
                            <tr>
        ...
        <div class="col-md-7">
                    ...
                    <table class="table table-sm mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td>Dr. {{ $admission->doctorProfile?->employee?->f_name }} {{ $admission->doctorProfile?->employee?->l_name }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ $admission->admittedBy?->f_name.' '.$admission->admittedBy?->l_name ?: '—' }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>{{ \App\Models\IpdAdmission::DISCHARGE_TYPES[$admission->discharge_type] ?? $admission->discharge_type }}</td>
                            </tr>
                            <tr>
                                <td class="text-muted">Discharged By</td>
                                <td>{{ $admission->dischargedBy?->f_name.' '.$admission->dischargedBy?->l_name ?: '—' }}</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
            ...
            <div class="card mb-3">
                <div class="card-header py-2"><h6 class="mb-0">Discharge Summary</h6></div>
                <div class="card-body" style="white-space:pre-wrap; font-size:13px;">{{ $admission->discharge_summary }}</div>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center"
             style="cursor:pointer;" data-toggle="collapse" data-target="#consentPanel">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="5" class="text-center text-muted py-3">No consent forms recorded.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center"
             style="cursor:pointer;" data-toggle="collapse" data-target="#nursingNotesPanel">
        ...
        <div id="nursingNotesPanel" class="collapse show">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea name="note" class="form-control form-control-sm" rows="1"
                                placeholder="Enter nursing note..." required></textarea>
                        </div>
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    <thead class="thead-light">
                        <tr><th style="width:160px;">Date &amp; Time</th><th style="width:140px;">Type</th><th>Note</th><th style="width:130px;">Recorded By</th><th style="width:60px;"></th></tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:12px;">{{ $note->recorder?->f_name }} {{ $note->recorder?->l_name }}</td>
                            <td>
                                <form action="{{ route('vendor.ipd.nursing-note.destroy', [$admission->id, $note->id]) }}"
                        ...
                        @empty
                        <tr><td colspan="5" class="text-center text-muted py-3">No nursing notes recorded.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center"
             style="cursor:pointer;" data-toggle="collapse" data-target="#dietPanel">
        ...
        <div id="dietPanel" class="collapse show">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    <thead class="thead-light">
                        <tr><th style="width:120px;">Date</th><th style="width:120px;">Meal</th><th style="width:160px;">Diet Type</th><th>Instructions</th><th style="width:130px;">Recorded By</th><th style="width:60px;"></th></tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:12px;">{{ $diet->recorder?->f_name }} {{ $diet->recorder?->l_name }}</td>
                            <td>
                        ...
                        @empty
                        <tr><td colspan="6" class="text-center text-muted py-3">No diet entries recorded.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
