 <form class="js-validate " action="{{ route('vendor.employee.add-new') }}" method="post" enctype="multipart/form-data">
     @csrf
     <style>
         .hidden_check {
             display: none;
                     ...
                     <div class="form-group col-md-4">
                         <label class="input-label text-capitalize"
                             for="f_name">{{ translate('messages.employee_id') }} @if (hasPermission('staff_manage', 'settings'))
                                 <span class="text-danger"><a href="{{ route('vendor.staff.settings') }}"
