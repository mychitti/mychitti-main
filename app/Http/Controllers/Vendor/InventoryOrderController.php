...
class InventoryOrderController extends Controller
{
    public function sale_orders(Request $request)
    {
        ...
        return view('vendor-views.inventory.sale.orders', compact('sales', 'preset', 'sale_order_items'));
    }
    public function  order_return(Request $request)
    {
        ...
        return view('vendor-views.inventory.sale.order_return', compact('preset', 'orders', 'returned_orders'));
    }
    ...
    {
        if (($return && hasPermission('permission:inventory_sale_return', 'export'))
            || (!$return  &&   hasPermission('permission:inventory_sale_order', 'export'))
        ) {
            $storeId = Helpers::get_store_id();
