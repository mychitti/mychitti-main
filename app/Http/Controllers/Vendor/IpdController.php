...
class IpdController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('vendor-views.ipd.index', compact('admissions', 'status', 'preset', 'from', 'to'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('vendor-views.ipd.create', compact('patients', 'doctors', 'wards', 'prefillPatient'));
    }
    ...
    public function show($id)
    {
        ...
        return view('vendor-views.ipd.show', compact('admission', 'nursingNotes', 'dietCharts', 'consents'));
    }
    ...
    public function dischargeForm($id)
    {
        ...
        return view('vendor-views.ipd.discharge', compact('admission'));
    }
    ...
    public function bedDashboard()
    {
        ...
        return view('vendor-views.ipd.bed_dashboard', compact('wards'));
    }
    ...
    private function generateAdmissionNumber(int $storeId): string
    {
        ...
        // Ensure uniqueness even if another store shares a number pattern
