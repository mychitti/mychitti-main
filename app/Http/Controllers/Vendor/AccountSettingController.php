...
class AccountSettingController extends Controller
{
    ...
    {
        $ledger_account_types = LedgerAccountType::with('account')->get();
        // prx($ledger_account_types);
        return view('vendor-views.account.setting.chart_of_account', compact('ledger_account_types'));
    }
    public function chart_of_account_detail(Request $request, $parent = null, $ledger_account_type = null)
    {
        ...
        $ledger_account_types = LedgerAccountType::with('account')->get();
        return view('vendor-views.account.setting.chart_of_account_detail', compact('storeAccounts', 'parentAccount', 'ledger_account'));
    }
    ...
    public function common_settings(Request $request)
    {
        ...
        return view('vendor-views.account.setting.common_settings', compact('storeConfig', 'expense_types'));
    }
