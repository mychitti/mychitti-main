...
class CashbookController extends Controller
{
    public function index(Request $request)
    {
        ...
        $bank_entries = StoreBankTransaction::where('store_id', Helpers::get_store_id())->whereBetween('value_date', [$formatted_from, $formatted_to])->get();
        return view('vendor-views.account.cash-book.index', compact('sales', 'from', 'to', 'daybook_entries', 'preset', 'bank_entries'));
    }
