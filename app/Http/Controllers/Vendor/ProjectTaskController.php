...
class ProjectTaskController extends Controller
{
    ...
    public function detail(Request $request, $id)
    {
        ...
        return view('vendor-views.project.task.details', compact('inventory_items', 'dynamicFieldsBySections', 'services', 'bill_num', 'tasks', 'data',  'staff', 'statuses', 'task_statuses', 'task_comments', 'task'));
    }
    ...
    public function list(Request $request, $empId = null)
    {
        ...
        // prx($tasks);
        return view('vendor-views.project.task.list', compact('staff', 'sales', 'preset', 'data', 'empId', 'tasks', 'statuses', 'from', 'to', 'status'));
    }
    ...
    public function assigned_tasks(Request $request)
    {
        ...
        $tasks = StoreTask::where('task_type', 'common')
            ...
            ->paginate(10);
        $data = [];
        return view('vendor-views.project.task.assigned', compact('empId', 'tasks', 'statuses', 'from', 'to', 'status'));
    }
    ...
    public function add(Request $request, $project_id = null)
    {
        ...
        $services = DB::table('items')
            ...
            ->get();
        return view('vendor-views.project.task.add', compact('projects','services', 'data', 'departments', 'data', 'rls', 'staff', 'store_data', 'statuses', 'titles', 'project'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('vendor-views.project.task.edit', compact('data', 'project', 'existingData', 'departments', 'task', 'rls', 'staff', 'store_data', 'statuses', 'titles'));
    }
    ...
    {
        $storeConfig = StoreConfig::where('store_id', Helpers::get_store_id())->first();
        return view('vendor-views.project.task.setting', compact('storeConfig'));
    }
    ...
    public function comment_edit(Request $request, $id)
    {
        ...
        return view('vendor-views.project.task.comment_edit', compact('comment', 'task'));
    }
