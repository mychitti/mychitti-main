...
class BranchController extends Controller
{
    public function index()
    {
        ...
        // $data['mainBranchesCount'] =  Branch::where('store_id', Helpers::get_store_id())->where('type', 'main')->count();
        // $data['subBranchesCount'] =  Branch::where('store_id', Helpers::get_store_id())->where('type', 'sub')->count();
        return view('vendor-views.branch.index', compact('branches'));
    }
