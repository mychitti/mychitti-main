...
class TaskController extends Controller
{
    ...
    public function detail(Request $request, $id)
    {
        ...
        return view('admin-views.task.details', compact('inventory_items', 'dynamicFieldsBySections', 'services', 'bill_num', 'tasks', 'data',  'staff', 'statuses', 'task_statuses', 'task_comments', 'task', 'taskTimeCard', 'taskTimeCardEvents'));
    }
    ...
    public function assigned_tasks(Request $request)
    {
        ...
        $tasks = StoreTask::where('task_type', 'common')
            ...
            ->paginate(10);
        $data = [];
        return view('admin-views.task.assigned', compact('empId', 'tasks', 'statuses', 'from', 'to', 'status'));
    }
    ...
    public function add(Request $request, $project_id = null)
    {
        ...
        $services = DB::table('items')
            ...
            ->get();
        return view('admin-views.task.add', compact('services', 'data', 'departments', 'data', 'rls', 'staff', 'store_data', 'statuses', 'titles', 'project'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin-views.task.edit', compact('data', 'project', 'existingData', 'departments', 'task', 'rls', 'staff', 'store_data', 'statuses', 'titles'));
    }
    ...
    {
        $storeConfig = StoreConfig::where('store_id', Helpers::get_store_id())->first();
        return view('admin-views.task.setting', compact('storeConfig'));
    }
    ...
    public function comment_edit(Request $request, $id)
    {
        ...
        return view('admin-views.task.comment_edit', compact('comment', 'task'));
    }
