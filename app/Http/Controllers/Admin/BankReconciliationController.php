...
class BankReconciliationController extends Controller
{
  public function index(Request $request)
  {
    ...
    $bank_entries = StoreBankTransaction::with('bankAccount')->where('store_id', 0)->whereBetween('value_date', [$formatted_from, $formatted_to])->get();
...
// prx($groupedBankEntries);
    ...
    return view('admin-views.account.bank-reconciliation.index', compact('from', 'to', 'daybook_entries', 'preset', 'bank_entries'));
  }
}
