...
class MonthlyFinanceController extends Controller
{
    ...
    public function monthly_maintanance(Request $request)
    {
        ...
        return view('admin-views.account.monthly-finance.maintanance', compact( 'preset', 'records', 'masters'));
    }
    public function property_valuation(Request $request)
    {
        ...
        return view('admin-views.account.monthly-finance.property-valuation', compact("asset_depreciations"));
    }
}
