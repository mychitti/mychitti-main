...
class CancelOrder extends Mailable
{
    ...
    public function build()
    {
        ...
        $data=EmailTemplate::where('type','user')->where('email_type', 'cancel_order')->first();
        ...
        return $this->subject(translate('Order_Cancelled'))->view('email-templates.new-email-format-'.$template, ['company_name'=>$company_name,'data'=>$data,'title'=>$title,'body'=>$body,'footer_text'=>$footer_text,'copyright_text'=>$copyright_text,'order'=>$order]);
    }
}
