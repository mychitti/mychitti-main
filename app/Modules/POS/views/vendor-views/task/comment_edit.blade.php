        ...
        <div class="row g-2">
            <div class=" mb-2 row col-12 " >
                <div class="col-md-9 card h-100">
                    <form class="w-100 p-0" enctype="multipart/form-data" action="{{ $task->parent_id ?  route('vendor.task.subtask-update.update')  :  route('vendor.task.comment.update') }}"
                        method="post">
                        @csrf
                                ...
                                @foreach ($files as $file)
                                    <div class="position-relative">
                                        ...
                                        <a style="position: absolute;    border: 1px solid red;border-radius: 50%;top: -8px;right: -5px;"
                                            href="{{ route('vendor.task.comment.pic-delete', [$comment['id'], $file]) }}"><i
