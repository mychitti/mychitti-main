 ...
 @push('css_or_js') 
     ...
     <style>
         ...
         /* ── Sidenav base (desktop: vertical column) ── */
         .pos-category-sidenav {
             display: flex;
         ...
         @media (max-width: 991px) {
             ...
             .search_inp { width: 100%; }
             .coffee-header .btn-outline-danger { width: 100%; }

             /* Category sidenav: horizontal scrollable row */
             .pos-category-sidenav {
             ...
             .pos-category-sidenav::-webkit-scrollbar { height: 3px; }
             .pos-cat-btn {
                 white-space: nowrap;
                 flex-shrink: 0;
             ...
             /* Show Go To Cart footer */
             .cart_footer {
                 display: flex !important;
                 align-items: center;
                 justify-content: center;
             }
             .coffee-tab-content { padding-bottom: 60px; }

             /* Cart panel: static flow below items */
             .cart_form { position: static; max-height: none; }
             .coffee-cart { margin: 0 !important; }
         }
     </style>
                         ...
                         <div class="row">
                             @if ($data['category_position'] == 'sidenav')
                                 <div class="col-12 col-lg-2">
                                     <div class="pos-category-sidenav">
 ...
 @push('script_2')
     ...
     {{-- Mobile: force horizontal category nav via JS inline styles (overrides all CSS) --}}
     <script>
         (function() {
             if (window.innerWidth >= 992) return;
             function fixCatNav() {
                 var nav = document.querySelector('.pos-category-sidenav');
                 if (!nav) return;
             ...
             if (document.readyState === 'loading') {
                 document.addEventListener('DOMContentLoaded', fixCatNav);
             } else {
                 fixCatNav();
             }
         })();
     ...
     {{-- Mobile layout fix — loaded last so it wins the cascade --}}
     <style>
         @media (max-width: 991px) {
             .pos-category-sidenav {
                 flex-direction: row !important;
