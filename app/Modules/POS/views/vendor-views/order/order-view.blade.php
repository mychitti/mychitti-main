                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header border-0 align-items-start flex-wrap">
                        <div class="order-invoice-left d-flex d-sm-flex justify-content-between">
                            ...
                            @if($order['invoice_id'])
                             <h1 class="page-header-title">
                               {{ translate('messages.invoice_id') }} : {{ $order['invoice_id'] }} 
                             </h1>
                            @endif
                                <h5 class="">
                            ...
                            <div class="d-sm-none">
                                <a class="btn btn--primary print--btn font-regular"
                                    href={{ route('vendor.order.generate-order-invoice', [$order['id']]) }}>
                                                            ...
                                                            <div>
                                                                ...
                                                                @else
                                                                    @if (count(json_decode($detail['variation'], true)) > 0)
                                                                        ...
                                                                        @foreach (json_decode($detail['variation'], true)[0] as $key1 => $variation)
                                                                            @if (($key1 != 'stock' && $key1 != 'images') || ($order->store && config('module.' . $order->store->module->module_type)['stock']))
                                    ...
                                    <span class="delivery--information-single d-block">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="javascript:;" style="cursor:default;"
                                                                    class="textToCopy info deco-none">{{$address['contact_person_number'] }}</a>
                                                                <button
