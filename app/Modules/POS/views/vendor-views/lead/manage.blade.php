...
$(document).on('click','.lead_approval', function (){
    ...
    var status = $(this).attr('data-id');
     $.ajax({
         url: '{{ url('vendor/lead/lead_approval') }}',
        type: "POST",
        data: {
...
<div class="row g-2">
  <div class="col-md-12">
    <div class="card h-100">
      ...
      <form class="w-100" action="{{route('vendor.lead.save-info')}}" method="post" >
          @csrf
          ...
          <div class="form-row">
            ...
            <div class="col">
              ...
              <textarea class="form-control"  name="location" id="exampleFormControlTextarea1" rows="3">{{$lead->location}}</textarea>
            </div>
          </div>
          <div class="form-row">
        ...
        <div class="container">
          ...
          <div class="cards w-100">
             @if(count($previous_leads)-1)
               ...
               @if($cl->id != $lead->id)
               <a href="{{ route('vendor.lead.manage', [$cl->id]) }}">
            <div class="card">
