          ...
          <div class="modal-content">
              ...
              <div class="modal-body">  
                  @php
                      ...
                      $formAction = route('vendor.business-settings.new-bank-account');
                      $accountType = 'invoice';
                      $isPosContext = $currentRoute === 'vendor.pos.settings';

                      if (
                          Illuminate\Support\Str::endsWith(request()->url(), 'quotation-settings') ||
                          $currentRoute === 'vendor.quotation.settings'
                      ) {
                          $formAction = route('vendor.quotation.new-bank-account');
                          $accountType = 'quotation';
                      } elseif ($isPosContext) {
                          $formAction = route('vendor.pos.new-bank-account');
                          $accountType = 'pos';
                      }
                  @endphp
