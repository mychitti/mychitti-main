 ...
 @push('css_or_js')
     ...
     <link rel="stylesheet"
         href="{{ asset('public/assets/admin/css/') }}{{ $data['design'] }}?v={{ filemtime(public_path('assets/admin/css/' . $data['design'])) }}">
 @endpush
                 ...
                 <div class="col-lg-9 p-2 ">
                     ...
                     <div class="coffee-header mb-2">
                         <div class="d-flex flex-column">
                             ...
                             <p class="text-dark small mb-0">Last Token Amount:
                                 <strong>₹{{ $last_generated_amount }}</strong></p>
                         </div>
                     ...
                     <div class="coffee-tab-content active" id="tab_">
                         <div class="row">
                             @if ($data['category_position'] == 'sidenav')
                                 <div class="col-md-2 ">
                                     <div class="pos-category-sidenav" style="">
                 ...
                 <div class="col-lg-3">
                     <form action="{{ route('vendor.pos.token-generate') }}" method="post" class="cart_form"
                         ...
                         <div class="coffee-cart" id="cart">
                             ...
                             <button type="button" id="btn-pair-printer" class="btn btn-outline-secondary btn-sm mt-1"
                                 title="Pair USB printer for silent printing">
 ...
 @push('script_2')
     ...
     <script>
         ...
         function escposCut() {
             return new Uint8Array([GS, 0x56, 0x41, 0x10]);
         }
