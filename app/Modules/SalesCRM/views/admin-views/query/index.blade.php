...
<style>
    ...
    .pcard           { background:#fff; border:1px solid #e7eaf3; border-radius:6px; padding:10px 12px;
                       margin-bottom:8px; font-size:.82rem; cursor:grab; user-select:none; position:relative; }
    ...
    .pcard-delete { color:#c1c9d2; background:none; border:none; padding:0; font-size:.85rem; line-height:1; cursor:pointer; }
    .pcard-delete:hover { color:#dc3545; }
</style>
@endpush
...
<div class="content container-fluid">
    ...
    <form method="GET" class="row gx-2 mb-3 align-items-end">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('admin.sales-crm.query.index') }}" class="btn btn-white btn-sm">{{ translate('Reset') }}</a>
        </div>
    </form>
                ...
                <div class="pcard"
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="d-flex align-items-center" style="gap:8px;">
                            ...
                            <button type="button" class="pcard-delete" title="{{ translate('Delete') }}"
                                    onclick="event.stopPropagation(); mcDeleteQuery({{ $q->id }}, this)">
                                <i class="tio-clear"></i>
                            </button>
                        </span>
                    </div>
...
{{-- Lost Reason Modal (drag-to-Lost) --}}
...
(function () {
    ...
    window.mcDeleteQuery = function (id, btn) {
        ...
        $.ajax({
            ...
            error: function () {
                showToast('Failed to delete query', 'danger');
            }
        });
    };
})();
