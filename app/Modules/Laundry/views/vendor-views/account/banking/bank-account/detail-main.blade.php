            ...
            <div class="bank-header shadow">
                <div class="bank-account-info">
                    <div class="bank-account-details">
                        <h2>
                            {{ \App\CentralLogics\Helpers::get_store_data()->name }} Bank Statement
                        </h2>
                        <div class="d-flex gap-2 flex-wrap">
                            @foreach ($accounts as $key => $value)
                                ...
                                @endphp
                                <a href="{{ route('vendor.account.banking.bank-account.detail', [$value?->id]) }}"
            ...
            <div class="bank-main-content">
                <div class="bank-transactions-header">
                    ...
                    <div class="bank-filters">
                        ...
                        <a href="{{ route('vendor.account.banking.bank-account.transaction-export', ['all']) }}"
