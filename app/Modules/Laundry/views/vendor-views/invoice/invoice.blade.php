            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="invoice-btn-section clearfix d-print-none">
                        ...
                        <!-- <button id="pmnt_stts_btn" class="btn btn-success btn-lg ">
                            Paid
                        </button>
                        <button onclick="saveInvoice()" id="save_btn" class="btn btn-lg btn-print">
                            Save
                        </button> -->
                                                    ...
                                                    <td>
                                                        <div class="">
                                                            <div class="invoice-number-inner">
                                                                ...
                                                                <h2 class="name">Service Id: <span id="service_id">{{$service_id}}</span></h2>
                                                    ...
                                                    <td>
                                                        <div class="col-sm-6 mb-30">
                                                            <div class="invoice-number">
                                                                ...
                                                                <h2 class="name mb-10">{{$service_det->f_name . ' ' . $service_det->l_name}}</h2>
                                                                <p class="invo-addr-1 mb-0" >
                                                                   Phone : {{$service_det->phone}}<br />
                                                                    <!-- {{ $service_det->address ? "Address :  " .$service_det->address."<br />" : ''}} -->
                                                                    Address : {{$service_det->s_address}}<br /> 
                                                                    GST : {{$service_det->gst}}<br />
                                                                    Place of supply1 : {{$service_det->city}}<br />
                            ...
                            <div class="invoice-bottom border-shadow-bg bsb2 py-0 px-2">
                                <div class="row"> 
                                    ...
                                    <div class="payment-method mb-30">
                                            ...
                                            <ul class="payment-method-list-1 text-14 px-0">
                                        ...
                                        <div class="terms-conditions mb-30">
                                            ...
                                            <a target="_blank" href="{{route('vendor-terms-conditions', [$vendor_contact_det->id])}}">Terms and Conditions</a>
                                        </div>
                                    </div>
