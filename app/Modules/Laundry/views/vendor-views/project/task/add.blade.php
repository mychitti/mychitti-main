...
@section('content')
        ...
        <form class="w-100" id="task_form" enctype="multipart/form-data" action="{{ route('vendor.project.task.store') }}"
            ...
            <div class="form-wrapper">
                ...
                <div class="left-panel">
                    <!-- Client & Task Source -->
                    <div class="card">
                        <h4 class="tf-card-title">👥 Assignee Info</h4>
                            ...
                            <div class="row g-0">
                                ...
                                @else
                                    <div class=" col-md-6 p-1">
                                        ...
                                        <select id="project_id" name="project_id" data-placeholder="Select Project" class="tf-select js-select2-custom ">
                                            <option value=""></option>
                                            @foreach ($projects as $key => $s)
                                                <option value="{{ $s->id }}">
                                                    {{ $s->project_title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                @endif
                        ...
                        <div class="card-body p-3">
                            <div class="row g-0">
                                ...
                                <div class=" col-md-4 p-1">
                                    ...
                                    <input type="number" id="cost" name="task_amount" placeholder="0.000"
            ...
            <div class="tf-actions">
                @if (!$project && _isEnabled('task_recievable_receipt') && hasPermission('project_task', 'receivable_receipt'))
    ...
    @include('vendor-views/form_modals/add_task_category')
...
@push('script_2')
    ...
    <script>
        ...
        $("#view_job_card").on('click', function(e) {
            ...
            var form = $('<form>', {
                action: '{{ route('vendor.jobcard.view') }}',
                method: 'POST',
    ...
    @include('vendor-views.js.form-render')
@endpush
