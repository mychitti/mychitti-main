                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group ">
                          ...
                          <div class="form-group mb-0">
                            <label class="input-label qcont" for="name">Department</label>
                            <select class="form-control w-100" name="dep_id">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label class="input-label text-capitalize"
                                            for="email">Skills</label>
                                            <select class="js-example-tags" name="skills[]" value="{{$e['skills']}}"   multiple="multiple">
                                            </select>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="qualification" required value="{{$e['qualification']}}"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="d-flex">
                                                    @php $imgs = json_decode($e['documents']);@endphp
                                                    @if( $imgs )
                                                        @foreach($imgs as $key => $value)
                                                        @if(in_array(explode('.', $value)[1], ['png', 'jpg', 'jpeg', 'webp']))
                                                        <a class="m-2" style="cursor: zoom-in;" target="_blank" href="{{  asset('storage/app/public/vendor/documents/').'/'.$value }}"><img src="{{  asset('storage/app/public/vendor/documents/').'/'.$value }}" alt="" width="100px" style="height: 100px ; object-fit:cover;"><br>Image</a>
                                                        @else 
                                                        <a class="m-2"  target="_blank" href="{{  asset('storage/app/public/vendor/documents/').'/'.$value }}"><div style="width : 100px; border : 1px solid grey ; height: 100px ; object-fit:cover;" class="d-flex align-items-center justify-content-center">file</div> File</a>
                                                        @endif
                                                        @endforeach
                                                   @endif
                                                   </div>
