...
class SalaryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $salary = DB::table('vendor_employees')
            ...
            ->get();
        // prx($salary);
        return view('laundry::vendor.salary.index', compact('salary', 'month_year'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('laundry::vendor.salary.manage', compact('empInfo', 'month_year', 'salary', 'all_salaries', 'data'));
    }
    ...
    public function report(Request $request)
    {
        ...
        return view('laundry::vendor.salary.report', compact('salary', 'month'));
    }
    public function add()
    {
        $employees =  VendorEmployee::where('store_id', Helpers::get_store_id())->get();
        return view('laundry::vendor.salary.add', compact('employees'));
    }
    ...
    { // store's
        ...
        return view('laundry::vendor.salary.advance-requests', compact('advance_requests', 'staff'));
    }
    ...
    { // employee specific
        ...
        return view('laundry::vendor.salary.advance-requests', compact('advance_requests'));
    }
