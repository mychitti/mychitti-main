...
class VendorEmployeeController extends Controller
{
    ...
    public function leaves(Request $request)
    {
        ...
        return view('laundry::vendor.employee.leave', compact(
            'filter_year',
            'filter_month',
            'attendance',
            'day_data',
    ...
    public function attendance(Request $request)
    {
        ...
        return view('laundry::vendor.employee.attendance', compact('attendance', 'currentmonth'));
    }
    ...
    public function my_salary_history(Request $request)
    {
        ...
        return view('laundry::vendor.employee.salary-history', compact('all_salaries'));
    }
