...
class AttendanceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('laundry::vendor.attendance.index', compact('staff'));
    }
    ...
    public function report(Request $request)
    {
        ...
        return view('laundry::vendor.attendance.report', compact('staff', 'fromdate', 'todate', 'dates', 'formattedDate'));
    }
    ...
    public function manage(Request $request, $id)
    {
        ...
        return view('laundry::vendor.attendance.manage', compact(
            'staff',
            'departments',
            'filter_year',
            'filter_month',
