...
class StaffController extends Controller
{
    ...
    public function teams()
    {
        ...
        return view('laundry::vendor.employee.teams', compact('teams', 'staff'));
    }
    public function team_edit(Request $request, $id)
    {
        ...
        // prx($team_members);
        return view('laundry::vendor.employee.teams_edit', compact('team', 'staff', 'team_members'));
    }
    ...
    public function settings()
    {
        ...
        return view('laundry::vendor.staff.settings', compact('store', 'tAndCContentForStaff'));
    }
    public function departments()
    {
        ...
        return view('laundry::vendor.department.index', compact('departments'));
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('laundry::vendor.staff.index', compact('staff'));
    }
    public function edit(Request $request, $id)
    {
        ...
        return view('laundry::vendor.staff.manage', compact('staff', 'departments'));
    }
    ...
    public function add()
    {
        ...
        return view('laundry::vendor.staff.add', compact('departments'));
    }
