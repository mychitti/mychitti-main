...
namespace App\Modules\Laundry\Controllers\Admin;
...
class LaundryController extends Controller
{
    public function orders(Request $request)
    {
        ...
        return view('laundry::admin.orders', compact('orders', 'stores', 'search', 'storeId', 'status', 'from', 'to'));
    }
    ...
    public function challans(Request $request)
    {
        ...
        return view('laundry::admin.challans', compact('challans', 'stores', 'search', 'storeId', 'status', 'from', 'to'));
    }
}
