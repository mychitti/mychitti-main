...
Route::group(['prefix' => 'consent', 'as' => 'consent.'], function () {
    Route::group(['prefix' => 'template', 'as' => 'template.'], function () {
        Route::get('',           [ConsentController::class, 'templateIndex'])->name('index')->middleware('permission:consent_template,list');
    ...
    Route::get('',                           [ConsentController::class, 'index'])->name('index')->middleware('permission:consent_form,list');
    ...
    Route::get('template-content/{id}',      [ConsentController::class, 'templateContent'])->name('template-content')->middleware('permission:consent_form,add,consent_template,list');
});
