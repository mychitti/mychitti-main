 ...
 @section('content')
     <div class="content container-fluid">
         ...
         <div class="page-header">
             <h1 class="page-header-title"><i class="tio-filter-list"></i>Service Setup</h1>
         </div>
     </div>
     @include('layouts/vendor/partials/service-setup/_nav')
     <div class="row g-0  p-3 d-flex ">
         @if($tab == 'mychitti-services')
             @include('vendor-views.settings.service-setup.mychitti_services')
         @elseif($tab == 'my-services')
             @include('vendor-views.settings.service-setup.my_services')
         @endif
     </div>
 @endsection
