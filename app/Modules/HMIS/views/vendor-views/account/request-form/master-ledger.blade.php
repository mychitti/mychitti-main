 ...
 @section('content')
     <div class="content container-fluid">
         ...
         <!-- End Page Header -->
         <div class="row ">
             @if (hasPermission('apporval_form_master_ledger', 'add'))

                 <div class="col-md-7 p-4">
                     <div class="shadow">
                         <div class="vendor-header pb-2 mb-0">
                             <div
                                 class="container position-relative d-flex justify-content-between px-5 align-items-center">
                                 ...
                                 <div class="logo-container">
                                     <div class="company-logo">
                                         <img style="width: 100px;"
                                             src="{{ asset('storage/app/public/store/' . \App\CentralLogics\Helpers::get_store_data()->logo) }}"
                                             alt="">
                                     </div>
                                 </div>
                             </div>
                         ...
                         <form enctype="multipart/form-data" class="w-100 p-0"
                             action="{{ $edit ? route('vendor.account.request-form.master-ledger.update') : route('vendor.account.request-form.master-ledger.store') }}"
                             method="post">
                             @csrf
                                 ...
                                 <div class="row px-5">
                                     ...
                                     <div class="col-md-3 ">
                                         ...
                                         <div class="pt-2" style="text-align: end;">Receipt Voucher No <br>
                                             <b
                                                 class="voucher_number_show">#{{ $voucher?->voucher_number ?? $voucherNo }}</b>
                                         </div>
                                     </div>
                                 ...
                                 <div class="form-container">
                                     ...
                                     <div class="row g-1">
                                         ...
                                         <div class="col-md-3 col-sm-6">
                                             ...
                                             <input type="number" name="gst_amount" value="{{ $edit?->gst_amount }}" step="0.001"
                                                 placeholder="GST Amount" class="form-control">
                                         </div>
             ...
             @if (hasPermission('apporval_form_master_ledger', 'edit'))
                                                         ...
                                                         <a style="padding: 0 10px ; width: fit-content;"
                                                             ...
                                                             href="{{ route('vendor.account.request-form.master-ledger.index', [$req->id]) }}"
