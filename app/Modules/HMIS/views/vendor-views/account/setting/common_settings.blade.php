        ...
        @if (hasPermission('settings_common', 'edit'))
            <div class="main-content">
                <form class="" enctype="multipart/form-data" method="post"
                    action="{{ route('vendor.account.setting.all_update') }}">
                    @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <form
                                                action="{{ route('vendor.account.setting.account-option-delete', [$value->id]) }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        <form id="accountForm" enctype="multipart/form-data"
                            action="{{ route('vendor.account.setting.account-option-update') }}" method="post">
                            @csrf
                            ...
                            <div class="p-5 bg-light rounded" style="max-width: 550px; margin: 0 auto;">
                                <div class="row ">
                                    <form class="otpForm" style="margin: 0 auto;"
                                        action="{{ route('vendor.account.reset_accounts_module') }}" method="post">
...
@push('script_2')
    <script>
        ...
        $(".send_otp").on('click', function(e) {
            ...
            $.post({
                url: "{{ route('vendor.account.send_otp') }}",
