...
@section('title',translate('messages.price_update_list'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{translate('messages.price_update_list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$items->total()}}</span></h1>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body py-2">
                <form action="{{route('vendor.item.price-update')}}" method="post">
                    @csrf
...
<script>
    ...
    $('.update_quantity').on('click', function (){
        ...
        $.get({
            url: '{{url('/')}}/item/get-price-variations?id='+val,
            dataType: 'json',
