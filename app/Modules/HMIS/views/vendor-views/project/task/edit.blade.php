...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form class="w-100" id="task_form" enctype="multipart/form-data"
            action="{{ $task->parent_id ? route('vendor.project.task.subtask.update') : route('vendor.project.task.update') }}"
            method="post">
            @csrf
                                    ...
                                    <div class=" col-md-6 p-1">
                                        ...
                                        <div class="upgrade-card cust_det_card" {{ $style2 }}>
                                            ...
                                            <div class="customer_info">
                                                <h6 class="mb-0">{{ $task->user?->f_name . ' ' . $task->user?->l_name }}
                                                </h6>
                                ...
                                @if (!$project)
                                    ...
                                    <div class=" col-md-6 p-1">
                                        ...
                                        <select id="where_from" name="where_from" class="tf-select">
                                            ...
                                            <option {{ $task->where_from == 'on_call' ? 'selected' : '' }} value="on_call">
                                                On
                                                Call</option>
                                            <option {{ $task->where_from == 'my_chitti' ? 'selected' : '' }}
                                                value="my_chitti">
                                                My Chitti</option>
                                        </select>
                                    </div>
...
@push('script_2')
    ...
    @include('vendor-views.js.edit-form-render')
@endpush
