                                                ...
                                                <td class="text-center">
                                                    <div class="btn--container justify-content-center">
                                                        ...
                                                        @if (hasPermission('shift_manage', 'delete'))
                                                            ...
                                                            <form
                                                                action="{{ route('vendor.shifts.delete', [$shift['id']]) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" class="row" action="{{ route('vendor.shifts.update') }}">
                            @csrf
        ...
        <div class="modal fade" id="addShiftModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" class="row" action="{{ route('vendor.shifts.store') }}">
                            @csrf
                            <div class="col-12">
