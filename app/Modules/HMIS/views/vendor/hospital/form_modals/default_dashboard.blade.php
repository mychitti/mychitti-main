@php
    ...
    $ddOptions = [
        'main'            => ['icon' => 'tio-home',                'label' => 'Main Dashboard',         'desc' => 'Overview, wallet & appointments summary',       'module' => null],
        'leads_page'      => ['icon' => 'tio-chart-bar-1',         'label' => 'Appointments Page',      'desc' => 'List, filters and actions for all appointments', 'module' => null],
        'leads_dashboard' => ['icon' => 'tio-chart-bar-1',         'label' => 'Appointments Dashboard', 'desc' => 'Appointment stats, performance & analytics',     'module' => null],
