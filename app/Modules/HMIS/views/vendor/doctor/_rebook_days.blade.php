...
@endphp
{{-- A grid cell alongside OPD Room, Consultation Fee and Bio. It sits where Services used to:
     that multiselect grows tall enough to drag the whole row down, so it now has a wider row of
     its own below and this compact control takes the slot it left. --}}
<div class="col-md-3 form-group mb-0">
    <label class="input-label d-flex align-items-center mb-1" style="gap:8px; cursor:pointer;">
    ...
    <div id="rebook_days_wrap" class="input-group {{ $rbDays > 0 ? '' : 'd-none' }}">
    ...
    <small class="text-muted d-block mt-1">
        Counted from their last completed visit, and skips anyone who already has an appointment
        booked. Switch the feature on under
