...
@section('content')
    <div class="content container-fluid">
        <div class="page-header">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    ...
                    @if (hasPermission('banking_cash_book', 'export'))
                        <a class="btn btn-outline-primary  btn_sm "
                            href="{{ route('vendor.account.banking.cash-book.export') }}?date={{ date('Y-m-d') }}"><i
                                class="tio-upload-outlined"></i> Export</a>
                    @endif
                    @if (hasPermission('banking_cash_book', 'import'))
        ...
        @if (hasPermission('banking_cash_book', 'list'))
            <div class="card">
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="border-0">{{ translate('messages.remaining balance') }}</th>
                                </tr>
                            </thead>
                            <tbody id="set-rows">
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('vendor.account.banking.cash-book.import') }}" method="post"
