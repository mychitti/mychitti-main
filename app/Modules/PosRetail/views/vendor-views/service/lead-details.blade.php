                    ...
                    <div class="col-md-5" style=" height: 90vh; overflow: auto;">
                        ...
                        @endif
                           @if ($assignmentLogs->isNotEmpty())
                            <div class="mt-4">
                                <h5 class="mb-2" style="font-weight:600;">Assignment History</h5>
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered" style="font-size:0.85rem;">
                                        ...
                                        <tbody>
                                            @foreach ($assignmentLogs as $i => $log)
                                                <tr>
                                                    <td>{{ $i + 1 }}</td>
                                                    <td>{{ $log->assignee_name }}</td>
                                                    <td>
                                                        <span class="badge badge-{{ $log->assigned_type === 'staff' ? 'info' : 'primary' }}">
                                                            {{ ucfirst($log->assigned_type) }}
                                                        </span>
                                                    </td>
                                                    <td>{{ $log->assigner_name }}</td>
                                                    <td>{{ \Carbon\Carbon::parse($log->assigned_at)->format('d M Y, h:i A') }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
