                    ...
                    <div class="profile-info">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                @elseif(hasPermission('staff_manage', 'terminate'))
                                    ...
                                    <form action="{{ route('vendor.employee.terminate', [$emp['id']]) }}" method="get"
                                        id="category-{{ $emp['id'] }}">
                                        @csrf @method('get')
                                    </form>
                                @endif
                    ...
                    <div class="basic-info-item">
                        ...
                        <div class="basic-info-value">
                            ...
                            @if (hasPermission('salary_manage', 'view'))
                                <a href="{{ route('vendor.salary.edit', [$emp->id]) }}"
                ...
                <div class="occupation-grid">
                    ...
                    <div class="occupation-item">
                        <div class="occupation-text"><b>Documents</b><br>
                            <div>
                                <i class="tio-file"></i> <a
                                    href="{{ route('vendor.employee.view-id-card', [$emp->id]) }}" target="_blank">ID
                                    Card</a>
                            </div>
                            <div>
            ...
            <div class="card content-card">
                <div class="events-header">
                    ...
                    @if (hasPermission('leads_manage', 'list'))
                        <a href="{{ route('vendor.service.leads_list', ['id' => $emp->id]) }}"
                ...
                @foreach ($leads as $key => $lead)
                    <div class="event-card design-review-4">
                        ...
                        <div class="event-participants">
                            ...
                            <a target="_blank"
                                href="{{ route('vendor.service.lead-details', [$lead->service_request_id]) }}">View ></a>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="card content-card">
                <div class="events-header">
                    ...
                    @if (hasPermission('project', 'list'))
                        <a href="{{ route('vendor.project.all', ['id' => $emp->id]) }}" class="text-underline">View All
                            Projects</a>
                    @endif
                </div>
                    ...
                    <div class="event-card design-review{{ $key % 2 == 0 ? '-2' : '' }}">
                        ...
                        <div class="event-participants">
                            ...
                            <div class="participant-avatar">{{ $proj->teams ? count(json_decode($proj->teams)) : 0 }}
                                teams </div>
                            <a target="_blank" href="{{ route('vendor.project.details', [$proj->id]) }}"
            ...
            <div class="card content-card">
                <div class="events-header">
                    ...
                    @if (hasPermission('task', 'list'))
                        <a href="{{ route('vendor.task.list', ['id' => $emp->id]) }}" class="text-underline">View All
                            Tasks</a>
                    @endif
                </div>
                @foreach ($tasks as $key => $task)
                    <div class="event-card design-review-3">
                        ...
                        <div class="event-participants">
                            ...
                            <a target="_blank"
                                href="{{ $task->parent_id ? route('vendor.task.subtask.detail', [$task->id]) : route('vendor.task.detail', [$task->id]) }}">View
                                ></a>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('vendor.employee.comment-save') }}" method="post">
                            @csrf
