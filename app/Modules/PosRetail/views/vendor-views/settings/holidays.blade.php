        ...
        <div class="">
            <div class="card mb-1">
                ...
                <div class="card-body row">
                    <div class="col-md-6">
                        <form action="{{ route('vendor.settings.general.holiday.add') }}">
                            @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn--container justify-content-center">
                                                    ...
                                                    <form action="{{ route('vendor.settings.general.holiday.delete', [$hl->holiday_id]) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('vendor.settings.general.holiday.update') }}">
                            @csrf
    ...
    @push('script_2')
        <script>
            $(".edit_btn").on('click', function() {
                ...
                // $('#title_inp').focus()
                // $('#title_inp').focus().addClass('scale-animate');
                // $('#date_inp').addClass('scale-animate');
                //
                // setTimeout(function() {
                //     $('#title_inp, #date_inp').removeClass('scale-animate');
                // }, 500);
            })
        </script>
    @endpush
