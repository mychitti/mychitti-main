...
class POSController extends Controller
{
    public function index(Request $request)
    {
        ...
        ->latest()->paginate(10);
        return view('posretail::vendor.pos.index', compact('categories', 'products','store','category', 'keyword'));
    }
    ...
    public function quick_view(Request $request)
    {
        ...
        return response()->json([
            'success' => 1,
            'view' => view('posretail::vendor.pos._quick-view-data', compact('product'))->render(),
        ]);
    }
    ...
    public function quick_view_card_item(Request $request)
    {
        ...
        return response()->json([
            'success' => 1,
            'view' => view('posretail::vendor.pos._quick-view-cart-item', compact('product', 'cart_item', 'item_key'))->render(),
        ]);
    }
    ...
    public function addDeliveryInfo(Request $request)
    {
        ...
        return response()->json([
            'data' => $address,
            'view' => view('posretail::vendor.pos._address', compact('address'))->render(),
        ]);
    }
    ...
    {
        return view('posretail::vendor.pos._cart');
    }
    ...
    public function place_order(Request $request)
    {
        ...
        $order->invoice_id = _generateOrderInvoiceId($store->id);
