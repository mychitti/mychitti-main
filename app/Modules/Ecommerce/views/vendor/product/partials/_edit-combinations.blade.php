        ...
        <tbody>
            ...
            @foreach ($combinations as $key => $combination)
                <tr>
                    ...
                    <td>
                        <input type="number" name="mrpprice_{{ $combination['type'] }}"
                            value="{{ isset($combination['mrpprice']) ?  $combination['mrpprice'] : 0 }}" min="0" step="0.001" class="form-control"
                            required>
                    </td>
                    <td>
                        <input type="number" name="askingprice_{{ $combination['type'] }}"
                            value="{{ isset($combination['askingprice']) ? $combination['askingprice'] : 0 }}" min="0" step="0.0000001"
                            class="form-control" required>
                    </td>
                    <td>
                        <input type="hidden" name="price_{{ $combination['type'] }}"
                            value="{{ $combination['price'] }}" min="0" step="0.001">

                        <input type="number" value="{{ $combination['price'] }}" min="0" step="0.0000001"
