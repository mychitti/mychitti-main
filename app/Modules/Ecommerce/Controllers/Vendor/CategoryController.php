...
class CategoryController extends Controller
{
    function index(Request $request)
    {
        ...
        return view('ecommerce::vendor.category.index', compact('categories'));
    }
    ...
    public function selected(Request $request)
    {
        ...
        return view('ecommerce::vendor.category.selected', compact('items_1', 'items_2', 'store_data', 'module_categories', 'module_subcategories'));
    }
    ...
    function sub_index(Request $request)
    {
        ...
        $categories = Category::with(['parent'])
            ...
            ->latest()->paginate(config('default_pagination'));
        return view('ecommerce::vendor.category.sub-index', compact('categories'));
    }
    ...
    //         'view'=>view('ecommerce::vendor.category.partials._table',compact('categories'))->render(),
    ...
    //
    //        return response()->json([
    //            'view'=>view('ecommerce::vendor.category.partials._sub_table',compact('categories'))->render(),
    //            'count'=>$categories->count()
    //        ]);
    //    }
