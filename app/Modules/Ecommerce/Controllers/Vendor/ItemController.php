...
class ItemController extends Controller
{
    public function index()
    {
        ...
        return view('ecommerce::vendor.product.index', compact('keywords', 'categories', 'module_data', 'conditions'));
    }
    ...
    public function select_view(Request $request)
    {
        ...
        // print_r($product); die();
        return view('ecommerce::vendor.product.select_view', compact('product', 'search_term'));
    }
    ...
    public function view($id)
    {
        if (Helpers::get_store_data()->module->id == 5) {
            ...
            return view('ecommerce::vendor.product.view', compact('product', 'reviews'));
        } else {
            ...
            return view('ecommerce::vendor.product.service_view', compact('product', 'reviews'));
        }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('ecommerce::vendor.product.edit', compact('product', 'keywords', 'product_category', 'categories', 'module_data', 'temp_product', 'conditions', 'fee_category'));
    }
    ...
    public function update_variant_combination(Request $request)
    {
        ...
        return response()->json([
            'view' => view('ecommerce::vendor.product.partials._addMoreCombinations', compact('combinations', 'price', 'product_name', 'stock', 'types'))->render(),
    ...
    public function variant_combination(Request $request)
    {
        ...
        return response()->json([
            'view' => view('ecommerce::vendor.product.partials._variant-combinations', compact('combinations', 'price', 'product_name', 'stock'))->render(),
            'length' => count($combinations),
        ]);
    }
    ...
    public function list(Request $request)
    {
        ...
        $toggle_veg_non_veg = \App\CentralLogics\Helpers::get_view_keys()['toggle_veg_non_veg'] ?? false;
        return view('ecommerce::vendor.product.list', compact('items', 'category', 'type', 'sub_categories', 'toggle_veg_non_veg'));
    }

    public function search(Request $request)
    {
        $view = 'ecommerce::vendor.product.partials._table';
        ...
        if (isset($request->product_gallery) && $request->product_gallery == 1 && $settings_access == 1) {
            ...
            $view = 'ecommerce::vendor.product.partials._gallery';
    ...
    {
        $module_type = Helpers::get_store_data()->module->module_type;
        return view('ecommerce::vendor.product.bulk-import', compact('module_type'));
    }
    ...
    {
        return view('ecommerce::vendor.product.bulk-export');
    }
    ...
    public function stock_limit_list(Request $request)
    {
        ...
        $category = $category_id != 'all' ? Category::findOrFail($category_id) : null;
        $toggle_veg_non_veg = \App\CentralLogics\Helpers::get_view_keys()['toggle_veg_non_veg'] ?? false;
        return view('ecommerce::vendor.product.stock_limit_list', compact('items', 'category', 'type', 'toggle_veg_non_veg'));
    }
    public function price_update_list(Request $request)
    {
        ...
        $category = $category_id != 'all' ? Category::findOrFail($category_id) : null;
        $toggle_veg_non_veg = \App\CentralLogics\Helpers::get_view_keys()['toggle_veg_non_veg'] ?? false;
        return view('ecommerce::vendor.product.price_update_list', compact('items', 'category', 'type', 'toggle_veg_non_veg'));
    }
    ...
    public function get_variations(Request $request)
    {
        ...
        return response()->json([
            'view' => view('ecommerce::vendor.product.partials._update_stock', compact('product'))->render()
        ]);
    }
    public function get_price_variations(Request $request)
    {
        ...
        return response()->json([
            'view' => view('ecommerce::vendor.product.partials._update_price', compact('product'))->render()
        ]);
    }
    ...
    public function service_request_list()
    {
        ...
        // prx($product);
        $heading = 'New Leads';
        return view('ecommerce::vendor.product.service_request_list', compact('product', 'heading'));
    }
    ...
    public function pending_item_list(Request $request)
    {
        ...
        $sub_categories = $category_id != 'all' ? Category::where('parent_id', $category_id)->get(['id', 'name']) : [];
        $category = $category_id != 'all' ? Category::findOrFail($category_id) : null;
        return view('ecommerce::vendor.product.pending_list', compact('items', 'category', 'type', 'sub_categories'));
    }
    ...
    public function requested_item_view($id)
    {
        ...
        return view('ecommerce::vendor.product.requested_product_view', compact('product'));
    }
    ...
    public function product_gallery(Request $request)
    {
        ...
        return view('ecommerce::vendor.product.product_gallery', compact('items', 'category', 'type'));
    }
    ...
    public function flash_sale(Request $request)
    {
        ...
        return view('ecommerce::vendor.product.flash_sale.list', compact('items'));
    }
}
