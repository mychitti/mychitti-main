...
class CampaignController extends Controller
{
    function list(Request $request)
    {
        ...
        return view('ecommerce::vendor.campaign.list',compact('campaigns'));
    }

    function itemlist()
    {
        $campaigns=ItemCampaign::where('store_id', Helpers::get_store_id())->latest()->paginate(config('default_pagination'));
        return view('ecommerce::vendor.campaign.item_list',compact('campaigns'));
    }
    ...
    public function searchItem(Request $request){
        ...
        return response()->json([
            'view'=>view('ecommerce::vendor.campaign.partials._item_table',compact('campaigns'))->render(),
