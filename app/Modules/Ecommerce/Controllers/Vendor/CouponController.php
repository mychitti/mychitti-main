...
class CouponController extends Controller
{
    public function add_new(Request $request)
    {
        ...
        return view('ecommerce::vendor.coupon.index', compact('coupons'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ecommerce::vendor.coupon.edit', compact('coupon'));
    }
    ...
    //         'view'=>view('ecommerce::vendor.coupon.partials._table',compact('coupons'))->render(),
    //         'count'=>$coupons->count()
    //     ]);
    // }
}
