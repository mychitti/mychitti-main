...
class OrderController extends Controller
{
    public function list($status)
    {
        ...
        $status = $status;
        return view('ecommerce::vendor.order.list', compact('orders', 'status'));
    }
    ...
    public function generate_order_invoice($id)
    {
        ...
        foreach ($order->details as $key => $value) {
            ...
            $variation = json_decode($value->variation);
        }
        ...
        $data['user'] = $user;
        $html = FacadesView::make('invoice_template.shop', compact('order', 'data'))->render();
    ...
    //            'view'=>view('ecommerce::vendor.order.partials._table',compact('orders'))->render()
    //        ]);
    //    }
    ...
    public function details(Request $request, $id)
    {
        ...
        if (isset($order)) {
            ...
            return view('ecommerce::vendor.order.order-view', compact('order', 'reasons'));
        } else {
    ...
    public function generate_invoice($id)
    {
        ...
        return view('ecommerce::vendor.order.invoice', compact('order'));
    }
