...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        // WhatsApp — the staff panel runs off this file, so the module's routes have to exist
        // here as well as in vendor.php. The sidebar links to vendor.whatsapp.* by name for both
        // guards; a name missing here throws RouteNotFoundException and takes down every staff
        // page, not just the WhatsApp ones. Keep this block in step with routes/vendor.php.
