    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            // ADDONS =============
             ...
             Route::group(['prefix' => 'leave', 'as' => 'leave.', 'middleware' => ['planwise:leave_manage']], function () {
            ...
            Route::group(['prefix' => 'salary', 'as' => 'salary.', 'middleware' => ['planwise:salary_manage']], function () {
