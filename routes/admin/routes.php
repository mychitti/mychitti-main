...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'coupon', 'as' => 'coupon.', 'middleware' => ['module:coupon']], function () {
            Route::get('coupon',[CouponController::class, 'service_coupon'] )->name('service-coupon');
            Route::post('coupon-store',[CouponController::class, 'service_coupon_store'] )->name('service-coupon.store'); 
            Route::post('coupon-delete/{id}',[CouponController::class, 'service_coupon_delete'] )->name('service-coupon.delete'); 
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            Route::group(['prefix' => 'zone', 'as' => 'zone.', 'middleware' => ['module:zone']], function () {
                ...
                Route::get('area-request', [ZoneController::class, 'requests'])->name('requests');
                Route::post('approve', [ZoneController::class, 'approve'])->name('approve');
                Route::get('reject/{id}', [ZoneController::class, 'reject'])->name('reject');
