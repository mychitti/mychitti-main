...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor', 'module.resolve', 'module.resolve.views']], function () {
        ...
        //
        // Every route below carries its own permission. The module used to be wide open — the
        // sidebar was ungated on purpose because the routes were, so any employee could disconnect
        // the store's number, fire a broadcast or buy tokens. The feature rows behind these names
        // are seeded by App\Services\WhatsAppPermissions; the store owner always passes.
        Route::get('whatsapp/dashboard', 'WhatsAppController@dashboard')->name('whatsapp.dashboard')->middleware('permission:whatsapp,dashboard');
        Route::post('whatsapp/customers/import', 'WhatsAppController@importCustomers')->name('whatsapp.customers.import')->middleware('permission:whatsapp_bulk,import');
        Route::get('whatsapp/customers/template', 'WhatsAppController@customerTemplate')->name('whatsapp.customers.template')->middleware('permission:whatsapp_bulk,import');
        Route::get('whatsapp/connect', 'WhatsAppController@connect')->name('whatsapp.connect')->middleware('feature:whatsapp_connection,whatsapp_billing');
        Route::post('whatsapp/connect/finish', 'WhatsAppController@finish')->name('whatsapp.connect.finish')->middleware('permission:whatsapp_connection,edit');
        // One-time onboarding fee, collected before Embedded Signup links the number.
        Route::post('whatsapp/connect/setup-fee', 'WhatsAppController@connectSetupFee')->name('whatsapp.connect.setup-fee')->middleware('permission:whatsapp_connection,edit');
        Route::post('whatsapp/disconnect', 'WhatsAppController@disconnect')->name('whatsapp.disconnect')->middleware('permission:whatsapp_connection,delete');
        Route::get('whatsapp/numbers', 'WhatsAppController@numbers')->name('whatsapp.numbers')->middleware('feature:whatsapp_connection');
        Route::post('whatsapp/numbers/label', 'WhatsAppController@numberLabel')->name('whatsapp.numbers.label')->middleware('permission:whatsapp_connection,edit');
        Route::post('whatsapp/numbers/default', 'WhatsAppController@numberDefault')->name('whatsapp.numbers.default')->middleware('permission:whatsapp_connection,edit');
        Route::post('whatsapp/numbers/bind', 'WhatsAppController@numberBind')->name('whatsapp.numbers.bind')->middleware('permission:whatsapp_connection,edit');
        // Unhappy feedback, and what the patient said was wrong.
        Route::get('whatsapp/complaints', 'WhatsAppController@complaints')->name('whatsapp.complaints')->middleware('feature:whatsapp_complaints');
        Route::post('whatsapp/complaints/{id}/resolve', 'WhatsAppController@complaintResolve')->name('whatsapp.complaints.resolve')->middleware('permission:whatsapp_complaints,status_change');

        // A note typed by hand to one customer — shared by every module's customer screen.
        Route::get('whatsapp/note/quote', 'WhatsAppController@noteQuote')->name('whatsapp.note.quote')->middleware('permission:whatsapp_note,send_note');
        Route::post('whatsapp/note/send', 'WhatsAppController@noteSend')->name('whatsapp.note.send')->middleware('permission:whatsapp_note,send_note');
        Route::get('whatsapp/inbox', 'WhatsAppController@inbox')->name('whatsapp.inbox')->middleware('feature:whatsapp_inbox');
        Route::get('whatsapp/inbox/threads', 'WhatsAppController@inboxThreads')->name('whatsapp.inbox.threads')->middleware('feature:whatsapp_inbox');
        Route::get('whatsapp/inbox/thread', 'WhatsAppController@inboxThread')->name('whatsapp.inbox.thread')->middleware('feature:whatsapp_inbox');
        Route::post('whatsapp/inbox/send', 'WhatsAppController@inboxSend')->name('whatsapp.inbox.send')->middleware('permission:whatsapp_inbox,reply');
        Route::get('whatsapp/inbox/staff', 'WhatsAppController@inboxStaff')->name('whatsapp.inbox.staff')->middleware('permission:whatsapp_inbox,forward');
        Route::post('whatsapp/inbox/forward', 'WhatsAppController@inboxForward')->name('whatsapp.inbox.forward')->middleware('permission:whatsapp_inbox,forward');
        Route::get('whatsapp/inbox/media/{id}/download', 'WhatsAppController@inboxMediaDownload')->name('whatsapp.inbox.media-download')->middleware('feature:whatsapp_inbox');
        ...
        Route::get('whatsapp/message-log', 'MessageLogController@index')->name('whatsapp.message-log')->middleware('feature:whatsapp_logs');
        Route::get('whatsapp/templates', 'WhatsAppController@templates')->name('whatsapp.templates')->middleware('feature:whatsapp_templates');
        Route::post('whatsapp/templates/create', 'WhatsAppController@templateCreate')->name('whatsapp.templates.create')->middleware('permission:whatsapp_templates,add');
        Route::post('whatsapp/templates/use-preset', 'WhatsAppController@templateFromPreset')->name('whatsapp.templates.use-preset')->middleware('permission:whatsapp_templates,add');
        Route::post('whatsapp/templates/reminder-schedule', 'WhatsAppController@reminderSchedule')->name('whatsapp.templates.reminder-schedule')->middleware('permission:whatsapp_templates,edit');
        // Auto-reply knowledge documents (used by WhatsApp auto-reply).
        Route::get('whatsapp/knowledge', 'KnowledgeController@index')->name('whatsapp.knowledge')->middleware('feature:whatsapp_automation');
        Route::post('whatsapp/knowledge/store', 'KnowledgeController@store')->name('whatsapp.knowledge.store')->middleware('permission:whatsapp_automation,edit');
        Route::post('whatsapp/knowledge/update', 'KnowledgeController@update')->name('whatsapp.knowledge.update')->middleware('permission:whatsapp_automation,edit');
        Route::post('whatsapp/knowledge/toggle', 'KnowledgeController@toggle')->name('whatsapp.knowledge.toggle')->middleware('permission:whatsapp_automation,edit');
        Route::post('whatsapp/knowledge/delete', 'KnowledgeController@delete')->name('whatsapp.knowledge.delete')->middleware('permission:whatsapp_automation,edit');
        // Per-action notification preferences — one page per direction, tabbed by channel.
        Route::post('notification-settings/toggle', 'NotificationSettingController@toggle')->name('notification-settings.toggle')->middleware('permission:whatsapp_automation,edit');
        Route::post('notification-settings/timing', 'NotificationSettingController@timing')->name('notification-settings.timing')->middleware('permission:whatsapp_automation,edit');
        Route::post('notification-settings/service-recall', 'NotificationSettingController@serviceRecall')->name('notification-settings.service-recall')->middleware('permission:whatsapp_automation,edit');
        Route::get('notification-settings/{direction?}', 'NotificationSettingController@index')->name('notification-settings')->middleware('feature:whatsapp_automation');
        Route::post('whatsapp/templates/update', 'WhatsAppController@templateUpdate')->name('whatsapp.templates.update')->middleware('permission:whatsapp_templates,edit');
        // Trash hides a template but leaves it at Meta; only delete removes it there — so trash is
        // an edit and delete is its own permission.
        Route::post('whatsapp/templates/trash', 'WhatsAppController@templateTrash')->name('whatsapp.templates.trash')->middleware('permission:whatsapp_templates,edit');
        Route::post('whatsapp/templates/restore', 'WhatsAppController@templateRestore')->name('whatsapp.templates.restore')->middleware('permission:whatsapp_templates,edit');
        Route::post('whatsapp/templates/delete', 'WhatsAppController@templateDelete')->name('whatsapp.templates.delete')->middleware('permission:whatsapp_templates,delete');
        Route::post('whatsapp/test-message', 'WhatsAppController@sendTestMessage')->name('whatsapp.test-message')->middleware('throttle:5,1', 'permission:whatsapp_templates,edit');
        Route::get('whatsapp/bulk/recipients', 'WhatsAppController@bulkRecipients')->name('whatsapp.bulk.recipients')->middleware('feature:whatsapp_bulk');
        Route::post('whatsapp/bulk/send', 'WhatsAppController@bulkSend')->name('whatsapp.bulk.send')->middleware('permission:whatsapp_bulk,broadcast');
        ...
        Route::get('whatsapp/bulk/progress/{runId}', 'WhatsAppController@bulkProgress')->name('whatsapp.bulk.progress')->middleware('feature:whatsapp_bulk');
        Route::post('whatsapp/bulk/stop/{runId}', 'WhatsAppController@bulkStop')->name('whatsapp.bulk.stop')->middleware('permission:whatsapp_bulk,broadcast');
        ...
        Route::get('whatsapp/bulk', 'WhatsAppController@bulk')->name('whatsapp.bulk')->middleware('feature:whatsapp_bulk');
        Route::get('whatsapp/bulk/history', 'WhatsAppController@bulkHistory')->name('whatsapp.bulk.history')->middleware('feature:whatsapp_bulk');
        Route::get('whatsapp/bulk/history/{runId}', 'WhatsAppController@bulkHistoryRun')->name('whatsapp.bulk.history.run')->middleware('feature:whatsapp_bulk');
        Route::get('whatsapp/bulk/history/{runId}/export', 'WhatsAppController@bulkHistoryExport')->name('whatsapp.bulk.history.export')->middleware('permission:whatsapp_bulk,export');
        Route::post('whatsapp/features/subscribe', 'WhatsAppController@featureSubscribe')->name('whatsapp.features.subscribe')->middleware('permission:whatsapp_billing,pay');
        Route::post('whatsapp/features/toggle', 'WhatsAppController@featureToggle')->name('whatsapp.features.toggle')->middleware('permission:whatsapp_billing,pay');
        Route::post('whatsapp/features/auto-renew', 'WhatsAppController@featureAutoRenew')->name('whatsapp.features.auto-renew')->middleware('permission:whatsapp_billing,pay');
        // WhatsApp Business Platform billing — the monthly plan, template slots, AI tokens. Every
        // POST here spends the store's money, so they sit behind their own permission.
        Route::get('whatsapp/billing', 'WhatsAppController@billing')->name('whatsapp.billing')->middleware('feature:whatsapp_billing');
        Route::post('whatsapp/billing/subscribe', 'WhatsAppController@billingSubscribe')->name('whatsapp.billing.subscribe')->middleware('permission:whatsapp_billing,pay');
        Route::post('whatsapp/billing/authorize-mandate', 'WhatsAppController@billingAuthorizeMandate')->name('whatsapp.billing.authorize-mandate')->middleware('permission:whatsapp_billing,pay');
        Route::post('whatsapp/billing/cancel', 'WhatsAppController@billingCancel')->name('whatsapp.billing.cancel')->middleware('permission:whatsapp_billing,pay');
        Route::post('whatsapp/billing/account-manager', 'WhatsAppController@billingAccountManager')->name('whatsapp.billing.account-manager')->middleware('permission:whatsapp_billing,pay');
        Route::post('whatsapp/billing/template-slot', 'WhatsAppController@buyTemplateSlot')->name('whatsapp.billing.template-slot')->middleware('permission:whatsapp_billing,pay');
        Route::post('whatsapp/billing/tokens', 'WhatsAppController@buyTokens')->name('whatsapp.billing.tokens')->middleware('permission:whatsapp_billing,pay');
        Route::post('whatsapp/bulk/header-media', 'WhatsAppController@bulkHeaderMedia')->name('whatsapp.bulk.header-media')->middleware('permission:whatsapp_bulk,broadcast');
        // Which of the store's own templates each automation sends.
        Route::get('whatsapp/template-roles', 'WhatsAppController@templateRoles')->name('whatsapp.template-roles')->middleware('feature:whatsapp_automation');
        Route::post('whatsapp/template-roles', 'WhatsAppController@templateRoleSave')->name('whatsapp.template-roles.save')->middleware('permission:whatsapp_automation,edit');
        ...
        Route::get('whatsapp/automation', 'WhatsAppController@automation')->name('whatsapp.automation')->middleware('feature:whatsapp_automation');
        // What the AI Agent may do for customers, and what it may share with them.
        Route::get('whatsapp/bot', 'WhatsAppController@bot')->name('whatsapp.bot')->middleware('feature:whatsapp_automation');
        Route::post('whatsapp/bot/shares', 'WhatsAppController@botShares')->name('whatsapp.bot.shares')->middleware('permission:whatsapp_automation,edit');
        ...
        Route::get('whatsapp/campaigns', 'WhatsAppCampaignController@index')->name('whatsapp.campaigns')->middleware('feature:whatsapp_campaigns');
        Route::get('whatsapp/campaigns/create', 'WhatsAppCampaignController@create')->name('whatsapp.campaigns.create')->middleware('permission:whatsapp_campaigns,add');
        Route::post('whatsapp/campaigns/store', 'WhatsAppCampaignController@store')->name('whatsapp.campaigns.store')->middleware('permission:whatsapp_campaigns,add');
        Route::get('whatsapp/campaigns/{id}', 'WhatsAppCampaignController@show')->name('whatsapp.campaigns.show')->middleware('feature:whatsapp_campaigns');
        Route::get('whatsapp/campaigns/{id}/recipients', 'WhatsAppCampaignController@recipients')->name('whatsapp.campaigns.recipients')->middleware('feature:whatsapp_campaigns');
        Route::get('whatsapp/campaigns/{id}/export', 'WhatsAppCampaignController@export')->name('whatsapp.campaigns.export')->middleware('permission:whatsapp_campaigns,export');
        // Starting one sends real messages to real customers, so it is a permission of its own
        // rather than something anybody who can open the list may do.
        Route::post('whatsapp/campaigns/{id}/start', 'WhatsAppCampaignController@start')->name('whatsapp.campaigns.start')->middleware('permission:whatsapp_campaigns,status_change');
        Route::post('whatsapp/campaigns/{id}/pause', 'WhatsAppCampaignController@pause')->name('whatsapp.campaigns.pause')->middleware('permission:whatsapp_campaigns,status_change');
        Route::post('whatsapp/campaigns/{id}/cancel', 'WhatsAppCampaignController@cancel')->name('whatsapp.campaigns.cancel')->middleware('permission:whatsapp_campaigns,status_change');
        Route::post('whatsapp/campaigns/{id}/run-now', 'WhatsAppCampaignController@runNow')->name('whatsapp.campaigns.run-now')->middleware('permission:whatsapp_campaigns,status_change');
        Route::post('whatsapp/campaigns/{id}/delete', 'WhatsAppCampaignController@destroy')->name('whatsapp.campaigns.delete')->middleware('permission:whatsapp_campaigns,delete');
        ...
        Route::group(['prefix' => 'billing', 'as' => 'invoice.',], function () {
            ...
            Route::get('purchase-bill/edit/{id}', 'BillingController@purchase_bill_edit')->name('purchase-bill.edit')->middleware('permission:purchase_bill,update');
            Route::post('purchase-bill/update/{id}', 'BillingController@purchase_bill_update')->name('purchase-bill.update')->middleware('permission:purchase_bill,update');
