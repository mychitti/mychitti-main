 $('.submit_btn').on('click', function() {
        ...
        function addMoreRow(item = null) {
            ...
            var html = `<tr class="item_row" data-id="` + dataId + `">
                ...
                item_price + `"  step="0.1" name="item_price_new[]" placeholder="Price" class="form-control price item_price"></td>
        ...
        $(document).ready(function() {
            ...
            $('#customer_id, #inventory_items, #tnc_id').on('select2:open', function() {
                setTimeout(function() {
                    const $addNewOption = $('li.select2-results__option[id$="-add_new"]');
        ...
        function recalculateInvoice() {
            ...
            $('.item_row').each(function() {
                ...
                $(this).find('.item_total').val((amount + taxAmount).toFixed(2));
            });
